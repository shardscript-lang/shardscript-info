...
const mdxItemMap: Record<string, string> = {
  '1.1 · ShardScript Philosophy': 'shardscript-philosophy',
  '1.2 · Runtime Architecture': 'runtime-architecture',
  '1.3 · Installation & Setup': 'installation-and-setup',
  'Basic Math': 'basic-math',
  'Trigonometry & Logarithms': 'trigonometry-and-logarithms',
  'Random Number Generation': 'random-number-generation',
}

function ArticleLoader({ file }: { file: string }) {
...
export default function Docs() {
  ...
  const renderContent = () => {
    const mdxSlug = mdxItemMap[activeItem]
    if (mdxSlug) {
      const article = manifest.articles[mdxSlug]
      if (article) {
        return <ArticleLoader file={article.file} />
      }
    }
