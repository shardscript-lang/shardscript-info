...
<ul className="space-y-2 text-text-secondary">
  <Bullet>
    <InlineCode>Trigonometry &amp; Logarithms</InlineCode> — advanced <InlineCode>Math</InlineCode> functions.
  </Bullet>
  <Bullet>
    <InlineCode>Random Number Generation</InlineCode> — the <InlineCode>Random</InlineCode> static class.
  </Bullet>
</ul>
...
<Prose>
  ...
  <InlineCode>ShardScript.Framework</InlineCode>. The native binding for <InlineCode>Math.PI</InlineCode>,{" "}
  <InlineCode>Math.E</InlineCode>, <InlineCode>Math.Abs</InlineCode>, <InlineCode>Math.Min</InlineCode>,{" "}
  <InlineCode>Math.Max</InlineCode>, and the rounding functions is in{" "}
  <InlineCode>ShardScript.Framework/system/math.shard.cpp</InlineCode>.
</Prose>
