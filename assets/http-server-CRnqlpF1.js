import{j as e}from"./index-BQw6jbtc.js";function c(a){const s={p:"p",...a.components},{Bullet:l,Callout:h,CodeBlock:i,DocsTable:d,H2:n,InlineCode:r,Prose:t}=s;return l||o("Bullet"),h||o("Callout"),i||o("CodeBlock"),d||o("DocsTable"),n||o("H2"),r||o("InlineCode"),t||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(n,{children:"Summary"}),`
...
`,e.jsx(i,{code:"func ServerGetCallback(requestBody: string) -> string",language:"csharp",filename:"server_callback_signature.shard"}),`
...
public static func Main() -> void
{
  ...
  server.Listen("127.0.0.1", 8080);
  server.Dispose();
}`,language:"csharp",filename:"httpserver_shutdown.shard"}),`
`,e.jsx(n,{children:"See also"}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(l,{children:e.jsxs(s.p,{children:[e.jsx(r,{children:"HttpClient"})," — making HTTP requests against a server."]})}),e.jsx(l,{children:e.jsxs(s.p,{children:[e.jsx(r,{children:"TCP Sockets"})," — low-level network streams that underlie HTTP traffic."]})})]}),`
`,e.jsx(n,{children:"Source"}),`
`,e.jsx(t,{children:e.jsxs(s.p,{children:["The ",e.jsx(r,{children:"shard.http"})," implementation ships as part of"," ",`
`,e.jsx(r,{children:"ShardScript.Framework"}),". The native binding for ",e.jsx(r,{children:"HttpServer"}),","," ",`
`,e.jsx(r,{children:"HttpClient"}),", and ",e.jsx(r,{children:"HttpResponse"})," is in"," ",`
`,e.jsx(r,{children:"ShardScript.Framework/system/http.shard.cpp"}),"."]})})]})}function x(a={}){const{wrapper:s}=a.components||{};return s?e.jsx(s,{...a,children:e.jsx(c,{...a})}):c(a)}function o(a,s){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}export{x as default};
