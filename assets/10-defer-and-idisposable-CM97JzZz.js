import{j as e}from"./index-DkFwvLJL.js";function h(o){const s={p:"p",...o.components},{Bullet:t,Callout:l,CodeBlock:r,DocsTable:c,H2:a,InlineCode:n,Prose:i}=s;return t||d("Bullet"),l||d("Callout"),r||d("CodeBlock"),c||d("DocsTable"),a||d("H2"),n||d("InlineCode"),i||d("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:"Summary"}),`
