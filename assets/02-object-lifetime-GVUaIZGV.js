import{j as e}from"./index-DkFwvLJL.js";function d(r){const s={p:"p",...r.components},{Bullet:t,CodeBlock:l,DocsTable:c,H2:a,InlineCode:n,Prose:i}=s;return t||o("Bullet"),l||o("CodeBlock"),c||o("DocsTable"),a||o("H2"),n||o("InlineCode"),i||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:"Summary"}),`
...
contract.`]})})]})]})}function p(r={}){const{wrapper:s}=r.components||{};return s?e.jsx(s,{...r,children:e.jsx(d,{...r})}):d(r)}function o(r,s){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}export{p as default};
