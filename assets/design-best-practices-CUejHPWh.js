import{j as e}from"./index-DLc5xCYN.js";function d(i){const s={p:"p",...i.components},{Bullet:r,Callout:o,CodeBlock:l,H2:t,InlineCode:n,Prose:a}=s;return r||c("Bullet"),o||c("Callout"),l||c("CodeBlock"),t||c("H2"),n||c("InlineCode"),a||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:e.jsx(s.p,{children:`Writing a ShardScript native library is more than exporting two C-linkage symbols. The runtime expects a
