import{j as e}from"./index-OPpZgTHq.js";function h(t){const s={code:"code",p:"p",...t.components},{Bullet:d,Callout:l,CodeBlock:o,DocsTable:c,H2:i,InlineCode:n,Prose:r}=s;return d||a("Bullet"),l||a("Callout"),o||a("CodeBlock"),c||a("DocsTable"),i||a("H2"),n||a("InlineCode"),r||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
...
`,e.jsx(c,{headers:["Member","Parameters","Description"],rows:[[e.jsx(s.code,{children:"Parse(text)"}),e.jsxs(e.Fragment,{children:[e.jsx(n,{children:"text"}),": ",e.jsx(n,{children:"string"})]}),"Parses a JSON text and returns the root JsonNode."],[e.jsx(s.code,{children:"Get(key)"}),e.jsxs(e.Fragment,{children:[e.jsx(n,{children:"key"}),": ",e.jsx(n,{children:"string"})]}),"Returns the child node at the given object key."],[e.jsx(s.code,{children:"Set(key, value)"}),e.jsxs(e.Fragment,{children:[e.jsx(n,{children:"key"}),": ",e.jsx(n,{children:"string"}),", ",e.jsx(n,{children:"value"}),": ",e.jsx(n,{children:"JsonNode"})]}),"Sets or overwrites a key on an object node."],[e.jsx(s.code,{children:"Contains(key)"}),e.jsxs(e.Fragment,{children:[e.jsx(n,{children:"key"}),": ",e.jsx(n,{children:"string"})]}),"True if the node is an object and contains the key."],[e.jsx(s.code,{children:"At(index)"}),e.jsxs(e.Fragment,{children:[e.jsx(n,{children:"index"}),": ",e.jsx(n,{children:"int"})]}),"Returns the array element at the zero-based index."],[e.jsx(s.code,{children:"Add(value)"}),e.jsxs(e.Fragment,{children:[e.jsx(n,{children:"value"}),": ",e.jsx(n,{children:"JsonNode"})]}),"Appends a value to an array node."]]}),`
`,e.jsx(i,{children:"Returns"}),`
`,e.jsx(c,{headers:["Member","Return Type","Return Value"],rows:[[e.jsx(s.code,{children:"Parse(text)"}),"JsonNode","The root node of the parsed JSON document."],[e.jsx(s.code,{children:"Kind()"}),"string",'One of: "null", "bool", "number", "string", "array", "object".'],[e.jsx(s.code,{children:"IsNull()"}),"bool","True if the node is null or missing."],[e.jsx(s.code,{children:"IsObject()"}),"bool","True if the node is a JSON object."],[e.jsx(s.code,{children:"IsArray()"}),"bool","True if the node is a JSON array."],[e.jsx(s.code,{children:"AsInt()"}),"int","Integer value; non-number types return 0."],[e.jsx(s.code,{children:"AsDouble()"}),"double","Floating-point value; non-number types return 0.0."],[e.jsx(s.code,{children:"AsBool()"}),"bool","Boolean value; numbers test != 0, others return false."],[e.jsx(s.code,{children:"AsString()"}),"string","String value, or the JSON text for non-string nodes."],[e.jsx(s.code,{children:"Get(key)"}),"JsonNode","Child node, or null if missing or not an object."],[e.jsx(s.code,{children:"Set(key, value)"}),"void","No return value."],[e.jsx(s.code,{children:"Contains(key)"}),"bool","True if the object contains the key."],[e.jsx(s.code,{children:"Keys()"}),"string[]","All object keys, or an empty array for non-objects."],[e.jsx(s.code,{children:"Length()"}),"int","Array element count, or 0 for non-arrays."],[e.jsx(s.code,{children:"At(index)"}),"JsonNode","Array element, or null if out of bounds or not an array."],[e.jsx(s.code,{children:"Add(value)"}),"void","No return value."],[e.jsx(s.code,{children:"ToString()"}),"string","The node serialized back to compact JSON text."]]}),`
`,e.jsx(i,{children:"Exceptions / Errors"}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(d,{children:e.jsxs(s.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Invalid JSON"})," —"," ",`
`,e.jsx(n,{children:"JsonNode.Parse"}),` throws a runtime error if the input is malformed,
contains trailing characters, has unterminated strings, or uses invalid escape sequences.`]})}),e.jsx(d,{children:e.jsxs(s.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Set on null node"})," — Calling"," ",`
`,e.jsx(n,{children:"Set"})," on a null/missing node throws because there is no DOM tree to mutate."]})}),e.jsx(d,{children:e.jsxs(s.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Add on null node"})," — Calling"," ",`
`,e.jsx(n,{children:"Add"})," on a null/missing node throws for the same reason."]})}),e.jsx(d,{children:e.jsxs(s.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Nesting depth exceeded"}),` — Both parsing and
serialization enforce a maximum depth of 512 levels to prevent stack overflow on deeply
nested or cyclic structures.`]})}),e.jsx(d,{children:e.jsxs(s.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Non-finite number"})," — Serializing a"," ",`
...
`,e.jsx(n,{children:"Kind()"}),` returns stable string labels, while the convenience predicates
`,e.jsx(n,{children:"IsNull"}),", ",e.jsx(n,{children:"IsObject"}),", and"," ",`
...
between "missing", "null", and "present but zero".`]})}),`
...
public static func Main() -> void
{
  ...
  if (!target.IsNull() && target.Kind() == "number")
  {
...
to distinguish strings from other types.`]})})]})}function x(t={}){const{wrapper:s}=t.components||{};return s?e.jsx(s,{...t,children:e.jsx(h,{...t})}):h(t)}function a(t,s){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{x as default};
