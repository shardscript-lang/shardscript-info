import{j as e}from"./index-JSRqoYtX.js";function h(c){const n={p:"p",...c.components},{Bullet:a,Callout:o,CodeBlock:r,DocsTable:d,H2:i,InlineCode:s,Prose:t}=n;return a||l("Bullet"),o||l("Callout"),r||l("CodeBlock"),d||l("DocsTable"),i||l("H2"),s||l("InlineCode"),t||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
