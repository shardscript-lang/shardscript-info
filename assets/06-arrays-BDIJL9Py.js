import{j as e}from"./index-JSRqoYtX.js";function h(t){const r={code:"code",p:"p",...t.components},{Bullet:i,Callout:d,CodeBlock:c,DocsTable:o,H2:a,InlineCode:n,Prose:s}=r;return i||l("Bullet"),d||l("Callout"),c||l("CodeBlock"),o||l("DocsTable"),a||l("H2"),n||l("InlineCode"),s||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:e.jsxs(r.p,{children:["A ",e.jsx("strong",{children:"ShardScript array"}),` is a fixed-size, homogeneous, indexed
...
`,e.jsx(n,{children:"foreach"}),". Its type is inferred from the array's element type."]})})]}),`
...
index outside `,e.jsx(n,{children:"0 .. Length - 1"})," throws."]})}),e.jsx(i,{children:e.jsxs(r.p,{children:[e.jsx("strong",{children:"Runtime error — null array access:"})," indexing or reading"," ",`
...
`,e.jsx(n,{children:"null"})," for reference-element arrays."]})})]})}function p(t={}){const{wrapper:r}=t.components||{};return r?e.jsx(r,{...t,children:e.jsx(h,{...t})}):h(t)}function l(t,r){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{p as default};
