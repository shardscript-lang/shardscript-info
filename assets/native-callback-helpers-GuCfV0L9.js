import{j as e}from"./index-C1AvCmMi.js";function h(l){const r={p:"p",...l.components},{Bullet:s,Callout:c,CodeBlock:d,DocsTable:o,H2:i,InlineCode:n,Prose:t}=r;return s||a("Bullet"),c||a("Callout"),d||a("CodeBlock"),o||a("DocsTable"),i||a("H2"),n||a("InlineCode"),t||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
