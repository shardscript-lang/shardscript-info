import{j as e}from"./index-C1AvCmMi.js";function o(a){const t={p:"p",...a.components},{Bullet:r,Callout:h,CodeBlock:c,DocsTable:d,H2:i,InlineCode:n,Prose:s}=t;return r||l("Bullet"),h||l("Callout"),c||l("CodeBlock"),d||l("DocsTable"),i||l("H2"),n||l("InlineCode"),s||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
...
`,e.jsx(c,{code:'SymbolBuilder<NamespaceSymbol> ns(context, L"mynamespace");',language:"cpp"}),`
`,e.jsx(d,{headers:["Method","Parameters","Returns","Description"],rows:[[e.jsx(n,{children:"AddClass"}),e.jsxs(e.Fragment,{children:[e.jsx(n,{children:'L"Name"'}),", accessibility, linking, initializer lambda"]}),e.jsx(n,{children:"ClassSymbol*"}),"Registers a class inside the namespace."],[e.jsx(n,{children:"AddStruct"}),e.jsxs(e.Fragment,{children:[e.jsx(n,{children:'L"Name"'}),", accessibility, linking, initializer lambda"]}),e.jsx(n,{children:"StructSymbol*"}),"Registers a struct inside the namespace."],[e.jsx(n,{children:"AddInterface"}),e.jsxs(e.Fragment,{children:[e.jsx(n,{children:'L"Name"'}),", accessibility, initializer lambda"]}),e.jsx(n,{children:"InterfaceSymbol*"}),"Registers an interface inside the namespace."],[e.jsx(n,{children:"AddEnum"}),e.jsxs(e.Fragment,{children:[e.jsx(n,{children:'L"Name"'}),", initializer lambda"]}),e.jsx(n,{children:"EnumSymbol*"}),"Registers an enum inside the namespace."],[e.jsx(n,{children:"AddNamespace"}),e.jsxs(e.Fragment,{children:[e.jsx(n,{children:'L"inner"'}),", initializer lambda"]}),e.jsx(n,{children:"NamespaceSymbol*"}),"Registers a child namespace."],[e.jsx(n,{children:"AddMethod"}),e.jsxs(e.Fragment,{children:[e.jsx(n,{children:'L"Name"'}),", return type, linking, accessibility"]}),e.jsx(n,{children:"MethodSymbolBuilder"}),"Registers a namespace-level method."]]}),`
