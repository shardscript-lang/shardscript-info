import{j as e}from"./index-DkFwvLJL.js";function d(a){const r={p:"p",...a.components},{Bullet:i,Callout:h,CodeBlock:l,DocsTable:c,H2:s,InlineCode:n,Prose:t}=r;return i||o("Bullet"),h||o("Callout"),l||o("CodeBlock"),c||o("DocsTable"),s||o("H2"),n||o("InlineCode"),t||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(i,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"left"})," — For the string overload, any string path segment. For the"," ",`
`,e.jsx(n,{children:"DirectoryInfo"})," overloads, a ",e.jsx(n,{children:"DirectoryInfo"})," ",`
instance whose `,e.jsx(n,{children:"FullName"})," becomes the left side of the join."]})}),e.jsx(i,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"right"})," — For ",e.jsx(n,{children:"string / string"})," and"," ",`
...
instance whose file name is appended to the directory.`]})}),e.jsx(i,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"paths"})," — A ShardScript string array passed to"," ",`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(i,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Compile-time type mismatch"})," — The"," ",`
...
on the right fails semantic analysis.`]})}),e.jsx(i,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Empty join"})," — Calling"," ",`
`,e.jsx(n,{children:"Path.Join"})," with an empty array returns an empty string."]})}),e.jsx(i,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Invalid path characters"}),` — The join itself does not
...
`,e.jsx(c,{headers:["Overload","Return Type","Use Case"],rows:[[e.jsx(n,{children:"string / string"}),"string","Join two arbitrary path segments."],[e.jsx(n,{children:"DirectoryInfo / string"}),"DirectoryInfo","Descend into a subdirectory."],[e.jsx(n,{children:"new FileInfo(DirectoryInfo, string)"}),"FileInfo","Create a file path under a directory."],[e.jsx(n,{children:"Path.Join(string[])"}),"string","Join a runtime-collected list of segments."]]}),`
`,e.jsx(s,{children:"See also"}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(i,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"File & Path"})," — parsing and composing file-system paths."]})}),e.jsx(i,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"Directory & DirectoryInfo"})," — creating and inspecting directories."]})})]}),`
`,e.jsx(s,{children:"Source"}),`
`,e.jsx(t,{children:e.jsxs(r.p,{children:["The ",e.jsx(n,{children:"shard.filesystem"})," path helpers ship as part of"," ",`
`,e.jsx(n,{children:"ShardScript.Framework"}),". The native binding for ",e.jsx(n,{children:"Path.Join"}),","," ",`
the `,e.jsx(n,{children:"/"})," operator overloads, and related utilities is in"," ",`
`,e.jsx(n,{children:"ShardScript.Framework/system/filesystem.shard.cpp"}),"."]})})]})}function x(a={}){const{wrapper:r}=a.components||{};return r?e.jsx(r,{...a,children:e.jsx(d,{...a})}):d(a)}function o(a,r){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}export{x as default};
