import{j as e}from"./index-BQw6jbtc.js";function p(s){const n={em:"em",p:"p",...s.components},{Bullet:i,Callout:d,CodeBlock:a,DocsTable:l,H2:o,InlineCode:r,Prose:t}=n;return i||c("Bullet"),d||c("Callout"),a||c("CodeBlock"),l||c("DocsTable"),o||c("H2"),r||c("InlineCode"),t||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(o,{children:"Summary"}),`
