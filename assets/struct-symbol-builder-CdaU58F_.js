import{j as e}from"./index-BugjY_CW.js";function h(i){const r={p:"p",...i.components},{Bullet:s,Callout:o,CodeBlock:l,DocsTable:d,H2:c,InlineCode:t,Prose:n}=r;return s||a("Bullet"),o||a("Callout"),l||a("CodeBlock"),d||a("DocsTable"),c||a("H2"),t||a("InlineCode"),n||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(c,{children:"Summary"}),`
...
SHARDLIB_ENTRYPOINT
{
  ...
  ns.AddStruct(L"Vector2", ACS_PUBLIC, LINK_INSTANCE, [](SymbolBuilder<StructSymbol> st)
  {
...
`,e.jsx(o,{tone:"blue",children:e.jsx(r.p,{children:`Prefer structs for data that is small and copy-safe. If the type wraps a native handle, owns unmanaged memory, or
...
SHARDLIB_ENTRYPOINT
{
  ...
  geometry.AddStruct(L"Vector2", ACS_PUBLIC, LINK_INSTANCE, [](SymbolBuilder<StructSymbol> v2)
  {
...
SHARDLIB_ENTRYPOINT
{
  ...
  g_vector2Symbol = geometry.AddStruct(L"Vector2", ACS_PUBLIC, LINK_INSTANCE, [](SymbolBuilder<StructSymbol> v2)
  {
      g_vector2X = v2.AddField(L"X", TYPE_DOUBLE, LINK_INSTANCE, ACS_PUBLIC);
      g_vector2Y = v2.AddField(L"Y", TYPE_DOUBLE, LINK_INSTANCE, ACS_PUBLIC);

      v2.AddMethod(L"Zero", g_vector2Symbol, LINK_STATIC, ACS_PUBLIC)
...
SHARDLIB_ENTRYPOINT
{
  ...
  g_vector2Symbol = geometry.AddStruct(L"Vector2", ACS_PUBLIC, LINK_INSTANCE, [](SymbolBuilder<StructSymbol> v2)
  {
      ...
      v2.AddOperator(shard::TokenType::AddOperator, g_vector2Symbol, LINK_STATIC)
...
SHARDLIB_ENTRYPOINT
{
  ...
  graphics.AddStruct(L"Color", ACS_PUBLIC, LINK_INSTANCE, [](SymbolBuilder<StructSymbol> color)
  {
...
View the source on GitHub: `,e.jsx(t,{children:"https://github.com/Rikitav/ShardScript/blob/main/ShardScript/include/shard/semantic/SymbolBuilder.hpp"}),"."]})})]})}function m(i={}){const{wrapper:r}=i.components||{};return r?e.jsx(r,{...i,children:e.jsx(h,{...i})}):h(i)}function a(i,r){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{m as default};
