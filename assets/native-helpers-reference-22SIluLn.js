import{j as e}from"./index-B-x28vAk.js";function o(l){const t={p:"p",...l.components},{Bullet:s,CodeBlock:a,DocsTable:d,H2:i,InlineCode:n,Prose:r}=t;return s||c("Bullet"),a||c("CodeBlock"),d||c("DocsTable"),i||c("H2"),n||c("InlineCode"),r||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
...
`,e.jsx(a,{code:`#include <shard/runtime/NativeHelpers.hpp>
...
partially constructed instance is not leaked.`]})}),e.jsx(s,{children:e.jsxs(t.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Invalid standard-interface kind."})," ",`
`,e.jsx(n,{children:"Shard_GetStandardInterface"})," returns ",e.jsx(n,{children:"nullptr"}),` if the
supplied kind is outside the range of known standard interfaces.`]})})]}),`
...
`,e.jsx(r,{children:e.jsxs(t.p,{children:[e.jsx("strong",{children:"Null argument unwrapping."}),` The argument-unwrapping helpers used internally by the
runtime return `,e.jsx(n,{children:"nullptr"})," when a ",e.jsx(n,{children:"nint"}),` or object argument
is the managed `,e.jsx(n,{children:"null"}),` instance. Native callbacks that expect a non-null pointer
should validate the result before dereferencing it.`]})}),`
`,e.jsx(r,{children:e.jsxs(t.p,{children:[e.jsx("strong",{children:"Looking up standard interfaces."})," The C API exposes"," ",`
`,e.jsx(n,{children:"Shard_GetStandardInterface"}),` to retrieve the symbols for built-in interfaces
such as `,e.jsx(n,{children:"IPrintable"}),", ",e.jsx(n,{children:"IDisposable"}),","," ",`
`,e.jsx(n,{children:"IEnumerable<T>"}),", ",e.jsx(n,{children:"IThrowable"}),`, and the async
state-machine interfaces. Pass a `,e.jsx(n,{children:"ShardStandardInterfaceKind"}),` value cast to
`,e.jsx(n,{children:"int"}),"."]})}),`
`,e.jsx(a,{code:`#include <shard/ShardScriptExtern.hpp>

InterfaceSymbol* disposable = Shard_GetStandardInterface(
  context.Compilation,
  static_cast<int>(ShardStandardInterfaceKind::Disposable));`,language:"cpp",filename:"standard_interface_lookup.cpp"}),`
...
`,e.jsx(a,{code:`static ObjectInstance* MakeIntCell(const CallState& context)
{
...
`,e.jsx(n,{children:"ShardScript/include/shard/ShardScriptExtern.hpp"}),`.
View the source on GitHub:`," ",`
`,e.jsx(n,{children:"https://github.com/Rikitav/ShardScript/blob/main/ShardScript/include/shard/runtime/NativeHelpers.hpp"}),"."]})})]})}function j(l={}){const{wrapper:t}=l.components||{};return t?e.jsx(t,{...l,children:e.jsx(o,{...l})}):o(l)}function c(l,t){throw new Error("Expected component `"+l+"` to be defined: you likely forgot to import, pass, or provide it.")}export{j as default};
