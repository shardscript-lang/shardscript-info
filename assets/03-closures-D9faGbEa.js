import{j as e}from"./index-7OQU3gOS.js";function d(i){const t={p:"p",...i.components},{Bullet:r,Callout:l,CodeBlock:o,H2:s,InlineCode:n,Prose:a}=t;return r||c("Bullet"),l||c("Callout"),o||c("CodeBlock"),s||c("H2"),n||c("InlineCode"),a||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:e.jsxs(t.p,{children:["A ",e.jsx("strong",{className:"text-text-primary",children:"closure"})," is a lambda expression together with the variables it references from its enclosing scope. In ShardScript, closures are the mechanism that lets a lambda remember the context in which it was created, so it can use that context later, even after the surrounding function has returned."]})}),`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(r,{children:e.jsxs(t.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Callbacks and predicates"})," — pass a lambda to ",e.jsx(n,{children:"Where"}),", ",e.jsx(n,{children:"Select"}),", or any higher-order API and let it capture the comparison value."]})}),e.jsx(r,{children:e.jsxs(t.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Factory functions"})," — return a lambda that is preconfigured with settings from the factory call."]})}),e.jsx(r,{children:e.jsxs(t.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Event handlers"})," — capture the object or state the handler needs to update."]})}),e.jsx(r,{children:e.jsxs(t.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Encapsulation"})," — hide mutable state behind a narrow functional interface."]})})]}),`
...
`,e.jsx(s,{children:"Readonly capture semantics"}),`
...
`,e.jsx(s,{children:"Lifetime and heap promotion"}),`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(r,{children:e.jsx(t.p,{children:"Identify every local variable referenced inside a lambda but declared outside it."})}),e.jsx(r,{children:e.jsx(t.p,{children:"Create a compiler-generated capture class containing those variables as fields."})}),e.jsx(r,{children:e.jsx(t.p,{children:"Allocate an instance of that class on the GC heap."})}),e.jsx(r,{children:e.jsx(t.p,{children:"Rewrite the lambda's variable accesses to read from and write to the capture object."})}),e.jsx(r,{children:e.jsx(t.p,{children:"Store a reference to the capture object inside the delegate so the variables stay alive as long as the delegate does."})})]}),`
...
`,e.jsx(s,{children:"Non-capturing versus capturing lambdas"}),`
...
`,e.jsx(l,{tone:"amber",title:"Per-iteration capture is planned",children:e.jsxs(t.p,{children:["The pattern of copying the loop variable into a fresh local (",e.jsx(n,{children:"current"}),") so each lambda captures its own value is the intended idiom. It is not yet safe to store those lambdas in a collection and invoke them after the loop scope exits."]})})]})}function u(i={}){const{wrapper:t}=i.components||{};return t?e.jsx(t,{...i,children:e.jsx(d,{...i})}):d(i)}function c(i,t){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{u as default};
