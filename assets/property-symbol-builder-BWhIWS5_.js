import{j as e}from"./index-DLc5xCYN.js";function h(i){const r={p:"p",...i.components},{Bullet:s,Callout:d,CodeBlock:a,DocsTable:o,H2:l,InlineCode:t,Prose:n}=r;return s||c("Bullet"),d||c("Callout"),a||c("CodeBlock"),o||c("DocsTable"),l||c("H2"),t||c("InlineCode"),n||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(l,{children:"Summary"}),`
...
nameProp.AddSetter().SetCallback(&set_name);`,language:"cpp"}),`
...
`,e.jsx(o,{headers:["Method","Description"],rows:[[e.jsx(t,{children:"AddGetter()"}),"Adds a getter accessor to the property. The callback must return a value of the property type."],[e.jsx(t,{children:"AddSetter()"}),"Adds a setter accessor to the property. The callback receives the new value as its last argument and returns nullptr."],[e.jsx(t,{children:"AddBackingField()"}),"Creates a compiler-managed field that backs the property. Returns a SymbolBuilder<FieldSymbol>; call .Get() to obtain the FieldSymbol* for runtime read/write."],[e.jsx(t,{children:"SetCallback(callback)"}),"Binds a native callback to the most recently added accessor (getter or setter)."]]}),`
...
`,e.jsx(t,{children:"AddBackingField"})," returns ",e.jsx(t,{children:"SymbolBuilder<FieldSymbol>"}),"; call ",e.jsx(t,{children:".Get()"})," to obtain the ",e.jsx(t,{children:"FieldSymbol*"}),", which exposes"," ",`
...
`,e.jsx(n,{children:e.jsxs(r.p,{children:[e.jsx("strong",{children:"Auto-backing fields."})," Call ",e.jsx(t,{children:"AddBackingField()"}),` to create a
