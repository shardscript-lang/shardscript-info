import{j as e}from"./index-B-x28vAk.js";function o(i){const n={p:"p",...i.components},{Bullet:r,Callout:c,CodeBlock:l,H2:a,InlineCode:t,Prose:s}=n;return r||d("Bullet"),c||d("Callout"),l||d("CodeBlock"),a||d("H2"),t||d("InlineCode"),s||d("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:"Prerequisites"}),`
