import{j as e}from"./index-hFDFiLgA.js";function h(i){const n={p:"p",...i.components},{Bullet:a,Callout:o,CodeBlock:c,DocsTable:d,H2:r,InlineCode:t,Prose:s}=n;return a||l("Bullet"),o||l("Callout"),c||l("CodeBlock"),d||l("DocsTable"),r||l("H2"),t||l("InlineCode"),s||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(r,{children:"Summary"}),`
