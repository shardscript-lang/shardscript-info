import{j as e}from"./index-BQw6jbtc.js";function h(o){const n={p:"p",...o.components},{Bullet:i,Callout:d,CodeBlock:a,DocsTable:l,H2:r,InlineCode:t,Prose:s}=n;return i||c("Bullet"),d||c("Callout"),a||c("CodeBlock"),l||c("DocsTable"),r||c("H2"),t||c("InlineCode"),s||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(r,{children:"Summary"}),`
