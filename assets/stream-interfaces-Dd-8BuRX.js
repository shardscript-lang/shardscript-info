import{j as e}from"./index-DbX8E4-q.js";function h(t){const n={code:"code",p:"p",...t.components},{Bullet:i,Callout:l,CodeBlock:a,DocsTable:o,H2:c,InlineCode:s,Prose:r}=n;return i||d("Bullet"),l||d("Callout"),a||d("CodeBlock"),o||d("DocsTable"),c||d("H2"),s||d("InlineCode"),r||d("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(c,{children:"Summary"}),`
