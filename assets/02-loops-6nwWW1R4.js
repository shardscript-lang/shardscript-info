import{j as e}from"./index-DREHvARB.js";function h(t){const i={p:"p",span:"span",...t.components},{Bullet:s,Callout:c,CodeBlock:l,DocsTable:d,H2:o,InlineCode:n,Prose:r}=i;return s||a("Bullet"),c||a("Callout"),l||a("CodeBlock"),d||a("DocsTable"),o||a("H2"),n||a("InlineCode"),r||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(o,{children:"Summary"}),`
