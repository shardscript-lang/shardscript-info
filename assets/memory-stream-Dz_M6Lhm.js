import{j as e}from"./index-BsFLGxt-.js";function h(s){const n={p:"p",...s.components},{Bullet:a,Callout:d,CodeBlock:i,DocsTable:l,H2:o,InlineCode:t,Prose:r}=n;return a||c("Bullet"),d||c("Callout"),i||c("CodeBlock"),l||c("DocsTable"),o||c("H2"),t||c("InlineCode"),r||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(o,{children:"Summary"}),`
