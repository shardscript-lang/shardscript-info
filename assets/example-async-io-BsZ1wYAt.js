import{j as e}from"./index-DIkNH1R5.js";function h(i){const r={p:"p",...i.components},{Bullet:n,Callout:o,CodeBlock:l,DocsTable:c,H2:s,InlineCode:t,Prose:a}=r;return n||d("Bullet"),o||d("Callout"),l||d("CodeBlock"),c||d("DocsTable"),s||d("H2"),t||d("InlineCode"),a||d("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
