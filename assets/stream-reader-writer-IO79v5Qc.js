import{j as e}from"./index-DFYo8cca.js";function h(i){const r={code:"code",em:"em",p:"p",...i.components},{Bullet:d,Callout:l,CodeBlock:o,DocsTable:c,H2:t,InlineCode:n,Prose:s}=r;return d||a("Bullet"),l||a("Callout"),o||a("CodeBlock"),c||a("DocsTable"),t||a("H2"),n||a("InlineCode"),s||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(t,{children:"Summary"}),`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(d,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"RuntimeException — Invalid UTF-8 sequence"})," ",`
`,e.jsx(n,{children:"StreamReader.Read()"}),` throws when the leading byte or its continuation
bytes do not form a valid UTF-8 codepoint.`]})}),e.jsx(d,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"RuntimeException — Cannot access a disposed StreamReader"})," ",`
Any call after `,e.jsx(n,{children:"Close()"})," or ",e.jsx(n,{children:"Dispose()"})," fails."]})}),e.jsx(d,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"RuntimeException — Cannot access a disposed StreamWriter"})," ",`
Any call after `,e.jsx(n,{children:"Close()"})," or ",e.jsx(n,{children:"Dispose()"})," fails."]})}),e.jsx(d,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"RuntimeException — Stream does not support Read / Write"})," ",`
Thrown by the underlying byte stream if the wrapped object does not implement the expected
interface method.`]})}),e.jsx(d,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"RuntimeException — Cannot access a closed stream"})," ",`
...
public static func Main() -> void
{
  ...
  writer.Dispose();
  writer3.Dispose();
}`,language:"csharp",filename:"stream_reader_writer_edge_cases.shard"})]})}function x(i={}){const{wrapper:r}=i.components||{};return r?e.jsx(r,{...i,children:e.jsx(h,{...i})}):h(i)}function a(i,r){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{x as default};
