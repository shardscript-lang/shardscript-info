import{j as e}from"./index-Cg_ascQj.js";function h(i){const t={p:"p",...i.components},{Bullet:s,Callout:c,CodeBlock:r,DocsTable:o,H2:l,InlineCode:n,Prose:a}=t;return s||d("Bullet"),c||d("Callout"),r||d("CodeBlock"),o||d("DocsTable"),l||d("H2"),n||d("InlineCode"),a||d("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(l,{children:"Summary"}),`
