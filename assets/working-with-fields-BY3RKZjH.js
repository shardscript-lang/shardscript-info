import{j as e}from"./index-DbX8E4-q.js";function o(i){const n={p:"p",...i.components},{Bullet:r,Callout:c,CodeBlock:l,H2:a,InlineCode:t,Prose:s}=n;return r||d("Bullet"),c||d("Callout"),l||d("CodeBlock"),a||d("H2"),t||d("InlineCode"),s||d("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:"Prerequisites"}),`
...
SHARDLIB_ENTRYPOINT
{
  ...
  devices.AddClass(L"Sensor", ACS_PUBLIC, LINK_INSTANCE, [](SymbolBuilder<ClassSymbol> sensor)
  {
      sensor.AddProperty(L"Status", TYPE_STRING, LINK_INSTANCE, ACS_PUBLIC)
          .AddBackingField(&g_sensor_statusBacking)
          .AddGetter()
          .SetCallback([](const CallState& context)
          {
              ObjectInstance* self = context.Args[0];
