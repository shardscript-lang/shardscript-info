import{j as e}from"./index-B-x28vAk.js";function h(l){const i={p:"p",...l.components},{Bullet:a,Callout:c,CodeBlock:o,DocsTable:t,H2:s,InlineCode:n,Prose:r}=i;return a||d("Bullet"),c||d("Callout"),o||d("CodeBlock"),t||d("DocsTable"),s||d("H2"),n||d("InlineCode"),r||d("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
`,e.jsx(r,{children:e.jsxs(i.p,{children:["The ",e.jsx(n,{children:"shard.cinterop"})," standard library exposes the namespace"," ",`
...
code or the POSIX `,e.jsx(n,{children:"dlerror"})," text."]})}),e.jsx(a,{children:e.jsxs(i.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Null library handle"}),` — Passing zero
to `,e.jsx(n,{children:"NativeLibrary.GetFunction"})," throws a runtime exception."]})}),e.jsx(a,{children:e.jsxs(i.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Null function pointer"})," — Every"," ",`
`,e.jsx(n,{children:"NativeCall"}),` method throws a runtime exception when the
function address is zero.`]})}),e.jsx(a,{children:e.jsxs(i.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Null pointer access"}),` — Marshal read,
write, and string-conversion methods throw a runtime exception when the supplied
pointer is zero and the operation length is non-zero.`]})}),e.jsx(a,{children:e.jsxs(i.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Namespace import required"})," — The"," ",`
...
visible.`]})}),e.jsx(a,{children:e.jsxs(i.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Mismatched return family"}),` — Using the
...
`,e.jsx(r,{children:e.jsxs(i.p,{children:[e.jsx("strong",{children:"Platform loaders."})," On Windows, ",e.jsx(n,{children:"NativeLibrary.Load"})," ",`
...
`,e.jsx(r,{children:e.jsxs(i.p,{children:[e.jsx("strong",{children:"Symbol names."})," ",e.jsx(n,{children:"NativeLibrary.GetFunction"})," ",`
...
`,e.jsx(r,{children:e.jsxs(i.p,{children:[e.jsx("strong",{children:"Memory ownership."})," Buffers returned by"," ",`
...
cleanup.`]})}),`
`,e.jsx(r,{children:e.jsxs(i.p,{children:[e.jsx("strong",{children:"Typed reads and writes are unchecked."})," The"," ",`
...
`,e.jsx(r,{children:e.jsxs(i.p,{children:[e.jsx("strong",{children:"String encoding."})," ",e.jsx(n,{children:"StringToAnsi"})," and"," ",`
...
`,e.jsx(r,{children:e.jsxs(i.p,{children:[e.jsx("strong",{children:"Calling convention and ABI."})," ",e.jsx(n,{children:"NativeCall"}),` relies
...
`,e.jsx(r,{children:e.jsxs(i.p,{children:[e.jsx("strong",{children:"Pointer arithmetic."})," ",e.jsx(n,{children:"Marshal.Add"}),` interprets
...
buffer.`]})}),`
`,e.jsx(c,{tone:"blue",children:e.jsxs(i.p,{children:["Always pair ",e.jsx(n,{children:"NativeLibrary.Load"})," with"," ",`
...
`,e.jsx(c,{tone:"amber",title:"Not implemented",children:e.jsxs(i.p,{children:["The ",e.jsx(n,{children:"Marshal.Alloc(size)"}),` overload registered by the runtime
...
`,e.jsx(r,{children:e.jsx("strong",{children:"Loading a library and handling failure."})}),`
...
`,e.jsx(r,{children:e.jsx("strong",{children:"Resolving an export and guarding against a missing symbol."})}),`
`,e.jsx(o,{code:`using stdio;
using interop;
...
`,e.jsx(r,{children:e.jsx("strong",{children:"Calling MessageBoxW on Windows with UTF-16 string marshalling."})}),`
`,e.jsx(o,{code:`using stdio;
using interop;
...
`,e.jsx(r,{children:e.jsx("strong",{children:"Reading and writing typed values in a native ANSI buffer."})}),`
`,e.jsx(o,{code:`using stdio;
using interop;
...
`,e.jsx(r,{children:e.jsx("strong",{children:"Pointer arithmetic over a UTF-16 buffer."})}),`
`,e.jsx(o,{code:`using stdio;
using interop;
...
`,e.jsx(r,{children:e.jsx("strong",{children:"Invoking a native function that returns double."})}),`
`,e.jsx(o,{code:`using stdio;
using interop;
...
`,e.jsx(r,{children:e.jsx("strong",{children:"Common mistake: using the wrong NativeCall return family."})}),`
`,e.jsx(o,{code:`using stdio;
using interop;
...
}`,language:"csharp",filename:"interop_wrong_family.shard"}),`
`,e.jsx(s,{children:"See also"}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(a,{children:e.jsxs(i.p,{children:[e.jsx(n,{children:"Native Library Development"})," — building the shared libraries loaded by"," ",`
`,e.jsx(n,{children:"NativeLibrary.Load"}),"."]})}),e.jsx(a,{children:e.jsxs(i.p,{children:[e.jsx(n,{children:"Type Introspection"})," — runtime type inspection for marshalled values."]})})]}),`
`,e.jsx(s,{children:"Source"}),`
`,e.jsx(r,{children:e.jsxs(i.p,{children:["The ",e.jsx(n,{children:"shard.cinterop"})," implementation ships as part of"," ",`
`,e.jsx(n,{children:"ShardScript.Framework"}),". The native binding for"," ",`
`,e.jsx(n,{children:"NativeLibrary"}),", ",e.jsx(n,{children:"Marshal"}),", and ",e.jsx(n,{children:"NativeCall"})," ",`
is in `,e.jsx(n,{children:"ShardScript.Framework/system/cinterop.shard.cpp"}),"."]})})]})}function u(l={}){const{wrapper:i}=l.components||{};return i?e.jsx(i,{...l,children:e.jsx(h,{...l})}):h(l)}function d(l,i){throw new Error("Expected component `"+l+"` to be defined: you likely forgot to import, pass, or provide it.")}export{u as default};
