import{j as e}from"./index-DLc5xCYN.js";function h(l){const a={em:"em",p:"p",...l.components},{Bullet:i,Callout:r,CodeBlock:o,DocsTable:d,H2:s,InlineCode:n,Prose:t}=a;return i||c("Bullet"),r||c("Callout"),o||c("CodeBlock"),d||c("DocsTable"),s||c("H2"),n||c("InlineCode"),t||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
