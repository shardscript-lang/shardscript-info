import{j as e}from"./index-hFDFiLgA.js";function l(a){const s={p:"p",...a.components},{Bullet:o,CodeBlock:d,DocsTable:t,H2:i,InlineCode:n,Prose:r}=s;return o||c("Bullet"),d||c("CodeBlock"),t||c("DocsTable"),i||c("H2"),n||c("InlineCode"),r||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
...
`,e.jsx(n,{children:"https://github.com/Rikitav/ShardScript/blob/main/ShardScript.Framework/system/time.shard.cpp"}),"."]})})]})}function h(a={}){const{wrapper:s}=a.components||{};return s?e.jsx(s,{...a,children:e.jsx(l,{...a})}):l(a)}function c(a,s){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}export{h as default};
