import{j as e}from"./index-BQw6jbtc.js";function h(c){const n={code:"code",p:"p",...c.components},{Bullet:i,Callout:d,CodeBlock:a,DocsTable:l,H2:r,InlineCode:t,Prose:s}=n;return i||o("Bullet"),d||o("Callout"),a||o("CodeBlock"),l||o("DocsTable"),r||o("H2"),t||o("InlineCode"),s||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(r,{children:"Summary"}),`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(i,{children:e.jsxs(n.p,{children:[e.jsx(t,{children:"IEnumerable & IEnumerator"})," — the iteration contract implemented by queues and stacks."]})}),e.jsx(i,{children:e.jsxs(n.p,{children:[e.jsx(t,{children:"List<T>"})," — a dynamic array collection with indexed access."]})})]}),`
...
`,e.jsx(t,{children:"ShardScript.Framework"}),". The native binding for ",e.jsx(t,{children:"Queue<T>"}),","," ",`
`,e.jsx(t,{children:"Stack<T>"}),", and their enumerators is in"," ",`
`,e.jsx(t,{children:"ShardScript.Framework/system/collections.shard.cpp"}),"."]})})]})}function x(c={}){const{wrapper:n}=c.components||{};return n?e.jsx(n,{...c,children:e.jsx(h,{...c})}):h(c)}function o(c,n){throw new Error("Expected component `"+c+"` to be defined: you likely forgot to import, pass, or provide it.")}export{x as default};
