import{j as e}from"./index-DFYo8cca.js";function h(s){const t={p:"p",...s.components},{Bullet:o,Callout:c,CodeBlock:a,DocsTable:r,H2:l,InlineCode:n,Prose:i}=t;return o||d("Bullet"),c||d("Callout"),a||d("CodeBlock"),r||d("DocsTable"),l||d("H2"),n||d("InlineCode"),i||d("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(l,{children:"Summary"}),`
