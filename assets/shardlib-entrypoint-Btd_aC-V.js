import{j as e}from"./index-BQw6jbtc.js";function h(a){const r={p:"p",strong:"strong",...a.components},{Bullet:t,Callout:c,CodeBlock:o,DocsTable:l,H2:s,InlineCode:n,Prose:i}=r;return t||d("Bullet"),c||d("Callout"),o||d("CodeBlock"),l||d("DocsTable"),s||d("H2"),n||d("InlineCode"),i||d("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(t,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Missing export"}),` — A library that does not export both
`,e.jsx(n,{children:"ShardLib_GetMetadata"})," and ",e.jsx(n,{children:"ShardLib_EntryPoint"}),` is rejected by the
runtime loader with a runtime error naming the library path.`]})}),e.jsx(t,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Missing metadata"})," — Leaving ",e.jsx(n,{children:"lib.Name"}),` or
`,e.jsx(n,{children:"lib.Version"})," as ",e.jsx(n,{children:"nullptr"}),` produces an invalid metadata record and may
cause the loader to skip the library.`]})}),e.jsx(t,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Unresolved dependency"}),` — If a dependency listed in
`,e.jsx(n,{children:"lib.Dependencies"}),` is not present, the runtime throws a load-order error before
`,e.jsx(n,{children:"ShardLib_EntryPoint"})," is invoked."]})}),e.jsx(t,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Registration-time C++ exception"}),` — Throwing from inside
`,e.jsx(n,{children:"SHARDLIB_ENTRYPOINT"}),` aborts library load and propagates the exception message to the
ShardScript host.`]})}),e.jsx(t,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Callback signature mismatch"}),` — Registering a native callback whose
...
`,e.jsx(i,{children:e.jsxs(r.p,{children:[e.jsx("strong",{children:"One logical library per build artifact."}),` A native library is any shared library that exports
`,e.jsx(n,{children:"ShardLib_GetMetadata"})," and ",e.jsx(n,{children:"ShardLib_EntryPoint"}),`. How you organize source
files and build rules is up to your project; the framework’s own CMake setup is one convenient integration, not a
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(t,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"library-building/accessibility-and-linking"})," — linking and accessibility values."]})}),e.jsx(t,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"library-building/native-library-overview"})," — native library loading overview."]})}),e.jsx(t,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"library-building/library-build-setup"})," — CMake build setup."]})}),e.jsx(t,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"library-building/headers-quick-reference"})," — header quick reference."]})})]}),`
