import{j as e}from"./index-B-x28vAk.js";function h(a){const t={p:"p",...a.components},{Bullet:r,Callout:d,CodeBlock:c,DocsTable:o,H2:s,InlineCode:n,Prose:i}=t;return r||l("Bullet"),d||l("Callout"),c||l("CodeBlock"),o||l("DocsTable"),s||l("H2"),n||l("InlineCode"),i||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
