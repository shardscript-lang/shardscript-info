import{j as e}from"./index-CoWj0v4y.js";function h(t){const r={p:"p",...t.components},{Bullet:s,Callout:c,CodeBlock:a,DocsTable:d,H2:o,InlineCode:n,Prose:i}=r;return s||l("Bullet"),c||l("Callout"),a||l("CodeBlock"),d||l("DocsTable"),o||l("H2"),n||l("InlineCode"),i||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(o,{children:"Summary"}),`
