import{j as e}from"./index-BQw6jbtc.js";function h(l){const t={p:"p",...l.components},{Bullet:s,Callout:c,CodeBlock:r,DocsTable:o,H2:i,InlineCode:n,Prose:a}=t;return s||d("Bullet"),c||d("Callout"),r||d("CodeBlock"),o||d("DocsTable"),i||d("H2"),n||d("InlineCode"),a||d("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(s,{children:e.jsxs(t.p,{children:[e.jsx(n,{children:"Delegates"})," — named and inline callable value types."]})}),e.jsx(s,{children:e.jsxs(t.p,{children:[e.jsx(n,{children:"Closures"})," — lambdas that capture variables from their enclosing scope."]})}),e.jsx(s,{children:e.jsxs(t.p,{children:[e.jsx(n,{children:"Functions"})," — core function declaration and call syntax."]})})]}),`
`,e.jsx(i,{children:"Source"}),`
`,e.jsx(a,{children:e.jsxs(t.p,{children:["Lambda expressions are parsed into ",e.jsx(n,{children:"LambdaExpressionSyntax"})," nodes in ",e.jsx(n,{children:"ShardScript/ShardScript/src/parsing/SourceParser.cpp"}),". The syntax node definition is in ",e.jsx(n,{children:"ShardScript/ShardScript/include/shard/parsing/nodes/Expressions/LambdaExpressionSyntax.hpp"}),"."]})})]})}function x(l={}){const{wrapper:t}=l.components||{};return t?e.jsx(t,{...l,children:e.jsx(h,{...l})}):h(l)}function d(l,t){throw new Error("Expected component `"+l+"` to be defined: you likely forgot to import, pass, or provide it.")}export{x as default};
