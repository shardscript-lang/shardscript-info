import{j as e}from"./index-DkFwvLJL.js";function h(a){const s={p:"p",...a.components},{Bullet:r,Callout:o,CodeBlock:i,DocsTable:d,H2:l,InlineCode:n,Prose:t}=s;return r||c("Bullet"),o||c("Callout"),i||c("CodeBlock"),d||c("DocsTable"),l||c("H2"),n||c("InlineCode"),t||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(l,{children:"Introduction"}),`
