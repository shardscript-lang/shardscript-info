import{j as e}from"./index-B-x28vAk.js";function h(o){const s={p:"p",...o.components},{Bullet:r,Callout:d,CodeBlock:t,DocsTable:c,H2:l,InlineCode:n,Prose:i}=s;return r||a("Bullet"),d||a("Callout"),t||a("CodeBlock"),c||a("DocsTable"),l||a("H2"),n||a("InlineCode"),i||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(l,{children:"Summary"}),`
