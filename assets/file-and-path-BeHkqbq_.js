import{j as e}from"./index-BQw6jbtc.js";function h(l){const n={code:"code",p:"p",...l.components},{Bullet:r,Callout:c,CodeBlock:a,DocsTable:d,H2:s,InlineCode:t,Prose:i}=n;return r||o("Bullet"),c||o("Callout"),a||o("CodeBlock"),d||o("DocsTable"),s||o("H2"),t||o("InlineCode"),i||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
...
`,e.jsx(d,{headers:["Method","Parameters","Returns","Description"],rows:[[e.jsx(n.code,{children:"ReadAllText(fileName)"}),e.jsxs(e.Fragment,{children:[e.jsx(t,{children:"fileName"}),": string"]}),"string","Opens the file and returns its entire contents as a string."],[e.jsx(n.code,{children:"ReadAllTextAsync(fileName)"}),e.jsxs(e.Fragment,{children:[e.jsx(t,{children:"fileName"}),": string"]}),"ValueTask<string>","Asynchronously opens the file and returns its entire contents as a string."],[e.jsx(n.code,{children:"WriteAllText(fileName, content)"}),e.jsxs(e.Fragment,{children:[e.jsx(t,{children:"fileName"}),": string, ",e.jsx(t,{children:"content"}),": string"]}),"void","Creates a new file or overwrites an existing one with the supplied text."],[e.jsx(n.code,{children:"WriteAllTextAsync(fileName, content)"}),e.jsxs(e.Fragment,{children:[e.jsx(t,{children:"fileName"}),": string, ",e.jsx(t,{children:"content"}),": string"]}),"Task","Asynchronously creates a new file or overwrites an existing one with the supplied text."],[e.jsx(n.code,{children:"Exists(fileName)"}),e.jsxs(e.Fragment,{children:[e.jsx(t,{children:"fileName"}),": string"]}),"bool","Returns true if the path refers to an existing file-system entry."],[e.jsx(n.code,{children:"Delete(fileName)"}),e.jsxs(e.Fragment,{children:[e.jsx(t,{children:"fileName"}),": string"]}),"void","Deletes the file if it exists; does nothing if it does not."],[e.jsx(n.code,{children:"Copy(sourceFileName, destFileName)"}),e.jsxs(e.Fragment,{children:[e.jsx(t,{children:"sourceFileName"}),": string, ",e.jsx(t,{children:"destFileName"}),": string"]}),"void","Copies source to destination, overwriting an existing destination file."],[e.jsx(n.code,{children:"Move(sourceFileName, destFileName)"}),e.jsxs(e.Fragment,{children:[e.jsx(t,{children:"sourceFileName"}),": string, ",e.jsx(t,{children:"destFileName"}),": string"]}),"void","Moves or renames a regular file from source to destination."]]}),`
