import{j as e}from"./index-DkFwvLJL.js";function h(t){const s={code:"code",p:"p",...t.components},{Bullet:c,Callout:d,CodeBlock:r,DocsTable:a,H2:o,InlineCode:n,Prose:i}=s;return c||l("Bullet"),d||l("Callout"),r||l("CodeBlock"),a||l("DocsTable"),o||l("H2"),n||l("InlineCode"),i||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(o,{children:"Summary"}),`
