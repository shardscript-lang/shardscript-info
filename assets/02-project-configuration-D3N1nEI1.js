import{j as e}from"./index-DkFwvLJL.js";function d(t){const s={p:"p",...t.components},{Bullet:n,CodeBlock:c,H2:l,InlineCode:r,Prose:i}=s;return n||a("Bullet"),c||a("CodeBlock"),l||a("H2"),r||a("InlineCode"),i||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(l,{children:"Prerequisites"}),`
...
`,e.jsx(i,{children:e.jsxs(s.p,{children:["Exactly one source file should declare a public static ",e.jsx(r,{children:"Main"}),` method. Place it in
`,e.jsx(r,{children:"src/main.shard"})," or another clearly named file so the project is easy to understand."]})}),`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(n,{children:e.jsxs(s.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Glob does not expand."})," Some shells do not expand"," ",`
`,e.jsx(r,{children:"**"}),` by default. Quote the glob so the interpreter expands it, or enable
recursive globbing in your shell.`]})}),e.jsx(n,{children:e.jsxs(s.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Entry point not found."})," Make sure ",e.jsx(r,{children:"Main"}),`
is `,e.jsx(r,{children:"public"}),", ",e.jsx(r,{children:"static"}),", and returns ",e.jsx(r,{children:"void"}),"."]})}),e.jsx(n,{children:e.jsxs(s.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Missing standard shards."})," Verify that the ",e.jsx(r,{children:"shard"}),`
executable has a `,e.jsx(r,{children:"system/"})," directory beside it, or use the"," ",`
`,e.jsx(r,{children:"SHARDSCRIPT"})," environment variable if your toolchain supports it."]})})]}),`
