import{j as e}from"./index-BQw6jbtc.js";function o(a){const r={p:"p",...a.components},{Bullet:n,Callout:d,CodeBlock:c,H2:i,InlineCode:s,Prose:t}=r;return n||l("Bullet"),d||l("Callout"),c||l("CodeBlock"),i||l("H2"),s||l("InlineCode"),t||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(t,{children:e.jsxs(r.p,{children:["Getting ShardScript running is a three-piece affair: the ",e.jsx(s,{children:"shard"}),` interpreter
...
`,e.jsx("a",{href:"https://github.com/Rikitav/ShardScript/releases/tag/0.5.1",className:"underline",children:"0.5.1 release"})," ",`
page. The installer scripts below download the matching archive and extract it into a system-wide directory.
The `,e.jsx(s,{children:"SHARDSCRIPT"}),` environment variable is created for tooling convenience, but the
...
`,e.jsx(c,{code:`# Option A: one-liner (run in an elevated PowerShell window)
...
for all users.`]})}),`
`,e.jsx(c,{code:`# Option A: one-liner (run as root or with sudo)
...
download `,e.jsx(s,{children:"shardscript-0.5.1-windows.zip"})," or"," ",`
`,e.jsx(s,{children:"shardscript-0.5.1-linux.tar.gz"})," from the"," ",`
`,e.jsx("a",{href:"https://github.com/Rikitav/ShardScript/releases/tag/0.5.1",className:"underline",children:"0.5.1 release"}),`,
...
`,e.jsx(c,{code:`-- Neovim: register the ShardScript language server via lspconfig
