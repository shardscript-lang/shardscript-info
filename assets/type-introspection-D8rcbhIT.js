import{j as e}from"./index-DLc5xCYN.js";function p(l){const n={code:"code",p:"p",...l.components},{Bullet:c,Callout:d,CodeBlock:i,DocsTable:o,H2:s,InlineCode:r,Prose:t}=n;return c||a("Bullet"),d||a("Callout"),i||a("CodeBlock"),o||a("DocsTable"),s||a("H2"),r||a("InlineCode"),t||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
...
types can be referenced.`]})}),e.jsx(c,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Type not found"})," — ",e.jsx(r,{children:"Type.GetType(name)"})," ",`
throws a runtime exception when the supplied name does not match any loaded type by simple or
fully-qualified name.`]})}),e.jsx(c,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Null instance introspection"})," —"," ",`
`,e.jsx(r,{children:"Type.Of(null)"})," returns ",e.jsx(r,{children:"null"}),`. It does not throw,
so the result must be checked before accessing members.`]})}),e.jsx(c,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Invalid element-type query"})," —"," ",`
...
public static func Main() -> void
{
  ...
  println(type.Name);
}`,language:"csharp",filename:"type_null.shard"}),`
`,e.jsx(s,{children:"See also"}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(c,{children:e.jsxs(n.p,{children:[e.jsx(r,{children:"IEnumerable & IEnumerator"})," — the iteration contract surfaced by reflected types."]})}),e.jsx(c,{children:e.jsxs(n.p,{children:[e.jsx(r,{children:"List<T>"})," — a generic collection whose members are visible through reflection."]})}),e.jsx(c,{children:e.jsxs(n.p,{children:[e.jsx(r,{children:"Dictionary<K, V>"})," — a generic collection whose members are visible through reflection."]})})]}),`
`,e.jsx(s,{children:"Source"}),`
`,e.jsx(t,{children:e.jsxs(n.p,{children:["The ",e.jsx(r,{children:"shard.reflection"})," implementation ships as part of"," ",`
`,e.jsx(r,{children:"ShardScript.Framework"}),". The native binding for ",e.jsx(r,{children:"Type"}),","," ",`
`,e.jsx(r,{children:"MethodInfo"}),", ",e.jsx(r,{children:"FieldInfo"}),", ",e.jsx(r,{children:"PropertyInfo"}),","," ",`
and `,e.jsx(r,{children:"ParameterInfo"})," is in"," ",`
`,e.jsx(r,{children:"ShardScript.Framework/system/reflection.shard.cpp"}),"."]})})]})}function y(l={}){const{wrapper:n}=l.components||{};return n?e.jsx(n,{...l,children:e.jsx(p,{...l})}):p(l)}function a(l,n){throw new Error("Expected component `"+l+"` to be defined: you likely forgot to import, pass, or provide it.")}export{y as default};
