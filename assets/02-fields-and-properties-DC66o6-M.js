import{j as e}from"./index-DkFwvLJL.js";function h(a){const t={p:"p",...a.components},{Bullet:s,Callout:o,CodeBlock:c,DocsTable:d,H2:r,InlineCode:i,Prose:n}=t;return s||l("Bullet"),o||l("Callout"),c||l("CodeBlock"),d||l("DocsTable"),r||l("H2"),i||l("InlineCode"),n||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(r,{children:"Summary"}),`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(s,{children:e.jsxs(t.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Private member access"}),` — Reading or
writing a `,e.jsx(i,{children:"private"}),` field or property from outside its
declaring type fails semantic analysis.`]})}),e.jsx(s,{children:e.jsxs(t.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Missing accessor"}),` — A property must
declare at least a getter or a setter. Writing to a read-only property, or reading
from a write-only property, produces an error.`]})}),e.jsx(s,{children:e.jsxs(t.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Static versus instance mismatch"}),` —
Accessing an instance member through the type name, or a static member through an
instance reference, is not allowed.`]})}),e.jsx(s,{children:e.jsxs(t.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Type mismatch"}),` — Assigning a value
of the wrong type to a field or property setter fails semantic analysis.`]})}),e.jsx(s,{children:e.jsxs(t.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Uninitialized reference"}),` — Fields of
reference types are initialized to `,e.jsx(i,{children:"null"}),` by the runtime.
Reading one before assignment throws a null-reference error.`]})}),e.jsx(s,{children:e.jsxs(t.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Null instance access"}),` — Reading or writing
an instance field through a `,e.jsx(i,{children:"null"})," reference throws"," ",`
`,e.jsx(i,{children:"Cannot access member on null instance of type ..."}),"."]})})]}),`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(s,{children:e.jsxs(t.p,{children:[e.jsx(i,{children:"Classes"})," — declaring types that contain fields and properties."]})}),e.jsx(s,{children:e.jsxs(t.p,{children:[e.jsx(i,{children:"Methods"})," — behavior that operates on fields and properties."]})}),e.jsx(s,{children:e.jsxs(t.p,{children:[e.jsx(i,{children:"Constructors and Initialization"})," — initializing fields at creation time."]})})]}),`
`,e.jsx(r,{children:"Source"}),`
`,e.jsx(n,{children:e.jsxs(t.p,{children:[`Field reads and writes are handled by the ShardScript virtual machine. The relevant opcodes and
runtime helpers live in `,e.jsx(i,{children:"ShardScript/src/runtime/VirtualMachine.cpp"}),"."]})})]})}function u(a={}){const{wrapper:t}=a.components||{};return t?e.jsx(t,{...a,children:e.jsx(h,{...a})}):h(a)}function l(a,t){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}export{u as default};
