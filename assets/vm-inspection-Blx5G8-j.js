import{j as e}from"./index-DFYo8cca.js";function h(a){const s={code:"code",p:"p",...a.components},{Bullet:o,Callout:d,CodeBlock:t,DocsTable:c,H2:i,InlineCode:n,Prose:r}=s;return o||l("Bullet"),d||l("Callout"),t||l("CodeBlock"),c||l("DocsTable"),i||l("H2"),n||l("InlineCode"),r||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
