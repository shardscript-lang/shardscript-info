import{j as e}from"./index-BugjY_CW.js";function h(i){const n={p:"p",...i.components},{Bullet:s,Callout:c,CodeBlock:a,DocsTable:o,H2:l,InlineCode:t,Prose:r}=n;return s||d("Bullet"),c||d("Callout"),a||d("CodeBlock"),o||d("DocsTable"),l||d("H2"),t||d("InlineCode"),r||d("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(l,{children:"Summary"}),`
