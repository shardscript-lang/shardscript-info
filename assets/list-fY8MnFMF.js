import{j as e}from"./index-DLc5xCYN.js";function h(r){const t={code:"code",p:"p",...r.components},{Bullet:l,Callout:d,CodeBlock:a,DocsTable:o,H2:s,InlineCode:n,Prose:i}=t;return l||c("Bullet"),d||c("Callout"),a||c("CodeBlock"),o||c("DocsTable"),s||c("H2"),n||c("InlineCode"),i||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
