import{j as e}from"./index-Cal9F7tC.js";function c(d){const s={p:"p",...d.components},{Callout:n,CodeBlock:i,DocsTable:l,H2:a,InlineCode:t,Prose:r}=s;return n||o("Callout"),i||o("CodeBlock"),l||o("DocsTable"),a||o("H2"),t||o("InlineCode"),r||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(r,{children:e.jsxs(s.p,{children:["Getting ShardScript running is a three-piece affair: the ",e.jsx(t,{children:"shard"}),` interpreter
...
language server.`]})}),`
`,e.jsx(a,{children:"Install from a Release (Windows)"}),`
`,e.jsx(r,{children:e.jsxs(s.p,{children:[`The fastest way to get ShardScript on Windows is to run the installer PowerShell script from the
latest GitHub release. The script downloads the prebuilt Windows archive, extracts it into`," ",`
`,e.jsx(t,{children:"%ProgramFiles%\\ShardScript"}),", and creates the"," ",`
`,e.jsx(t,{children:"%SHARDSCRIPT%"})," environment variable pointing at that directory."]})}),`
...
& ([scriptblock]::Create((irm https://shardscript-lang.github.io/shardscript-info/install-shardscript.ps1))) -AddToPath`,language:"powershell",filename:"install.ps1"}),`
`,e.jsx(r,{children:e.jsxs(s.p,{children:[`After the script finishes, open a new terminal so the updated environment variables take effect. The
interpreter will be located at `,e.jsx(t,{children:"%ProgramFiles%\\ShardScript\\shard.exe"}),` and the
standard shards will be in the `,e.jsx(t,{children:"system"})," folder beside it."]})}),`
`,e.jsx(n,{tone:"blue",title:"What the script does",children:e.jsxs(s.p,{children:["The installer requires Administrator privileges because it writes to"," ",`
`,e.jsx(t,{children:"%ProgramFiles%"}),` and updates machine-level environment variables. It downloads
`,e.jsx(t,{children:"shardscript-0.4.0-windows.zip"})," from the"," ",`
`,e.jsx("a",{href:"https://github.com/Rikitav/ShardScript/releases/tag/0.4.0",className:"underline",children:"0.4.0 release"}),`,
expands the archive, sets `,e.jsx(t,{children:"SHARDSCRIPT"}),` to the install root, and optionally appends
that root to `,e.jsx(t,{children:"PATH"}),"."]})}),`
...
development. Head to the language reference to start writing code.`]})})]})}function p(d={}){const{wrapper:s}=d.components||{};return s?e.jsx(s,{...d,children:e.jsx(c,{...d})}):c(d)}function o(d,s){throw new Error("Expected component `"+d+"` to be defined: you likely forgot to import, pass, or provide it.")}export{p as default};
