import{j as e}from"./index-BugjY_CW.js";function d(i){const t={p:"p",...i.components},{Bullet:r,Callout:l,CodeBlock:o,H2:s,InlineCode:n,Prose:a}=t;return r||c("Bullet"),l||c("Callout"),o||c("CodeBlock"),s||c("H2"),n||c("InlineCode"),a||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:e.jsxs(t.p,{children:["A ",e.jsx("strong",{className:"text-text-primary",children:"closure"})," is a lambda expression together with the variables it references from its enclosing scope. In ShardScript, closures are the mechanism that lets a lambda remember the context in which it was created, so it can use that context later, even after the surrounding function has returned."]})}),`
