import{j as e}from"./index-DbYfS1MK.js";function h(s){const a={em:"em",p:"p",...s.components},{Bullet:c,Callout:r,CodeBlock:l,DocsTable:d,H2:o,InlineCode:n,Prose:t}=a;return c||i("Bullet"),r||i("Callout"),l||i("CodeBlock"),d||i("DocsTable"),o||i("H2"),n||i("InlineCode"),t||i("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(o,{children:"Summary"}),`
