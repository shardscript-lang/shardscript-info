import{j as e}from"./index-B-x28vAk.js";function a(t){const n={p:"p",...t.components},{Bullet:i,Callout:o,CodeBlock:d,H2:c,InlineCode:s,Prose:r}=n;return i||l("Bullet"),o||l("Callout"),d||l("CodeBlock"),c||l("H2"),s||l("InlineCode"),r||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(c,{children:"Prerequisites"}),`
