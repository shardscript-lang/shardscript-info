import{j as e}from"./index-BqaCWg-u.js";function d(c){const t={p:"p",...c.components},{Bullet:a,Callout:l,CodeBlock:i,DocsTable:h,H2:s,InlineCode:n,Prose:r}=t;return a||o("Bullet"),l||o("Callout"),i||o("CodeBlock"),h||o("DocsTable"),s||o("H2"),n||o("InlineCode"),r||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
`,e.jsx(r,{children:e.jsxs(t.p,{children:["ShardScript exceptions transfer control from the point of failure to the nearest enclosing"," ",`
...
`,e.jsxs(r,{children:["Statement form — every ",e.jsx(n,{children:"try"})," must have at least one"," ",`
...
`,e.jsx(r,{children:e.jsxs(t.p,{children:[e.jsx(n,{children:"throw"}),` is also accepted as a prefix expression inside another expression,
...
`,e.jsx(r,{children:e.jsx("strong",{children:"Catch clause matching order:"})}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(a,{children:e.jsx(t.p,{children:`Clauses are evaluated in source order; the first clause whose type filter matches the thrown
object wins.`})}),e.jsx(a,{children:e.jsx(t.p,{children:`A typed catch matches the declared type and any subtype that implements the same interface or
inherits from the declared class.`})}),e.jsx(a,{children:e.jsxs(t.p,{children:["A catch with no explicit type (or with ",e.jsx(n,{children:"any"}),`) matches every object and
must be placed last, after all typed clauses.`]})})]}),`
`,e.jsx(s,{children:"Returns"}),`
`,e.jsx(r,{children:e.jsxs(t.p,{children:["A ",e.jsx(n,{children:"try"}),"/",e.jsx(n,{children:"catch"})," statement has no value. If the"," ",`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(a,{children:e.jsxs(t.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Try without catch"})," — A"," ",`
`,e.jsx(n,{children:"try"})," block with no following ",e.jsx(n,{children:"catch"}),` clause produces
a parser error: "'try' statement must have at least one 'catch' clause".`]})}),e.jsx(a,{children:e.jsxs(t.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Catch without variable or type"}),` — Every catch must
declare an exception variable, a type, or both. A bare `,e.jsx(n,{children:"catch "}),` is
rejected.`]})}),e.jsx(a,{children:e.jsxs(t.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Non-throwable catch type"}),` — A typed catch filter
...
fails semantic analysis.`]})}),e.jsx(a,{children:e.jsxs(t.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Throwing a non-throwable"}),` — The expression supplied to
a `,e.jsx(n,{children:"throw"})," statement must evaluate to an object implementing"," ",`
`,e.jsx(n,{children:"IThrowable"}),"."]})}),e.jsx(a,{children:e.jsxs(t.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Rethrow outside catch"})," — A bare"," ",`
`,e.jsx(n,{children:"throw;"})," compiles only inside a ",e.jsx(n,{children:"catch"}),` body where an
active exception exists.`]})}),e.jsx(a,{children:e.jsxs(t.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Unhandled exception"}),` — If an exception reaches the
entry point without being caught, the VM terminates and prints the stack trace captured at the
throw site.`]})})]}),`
`,e.jsx(s,{children:"Remarks"}),`
`,e.jsx(r,{children:e.jsxs(t.p,{children:[e.jsxs("strong",{children:["The ",e.jsx(n,{children:"IThrowable"})," interface."]}),` ShardScript defines a built-in
interface `,e.jsx(n,{children:"IThrowable"}),` in the global namespace. It declares two read-only
instance properties:`]})}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(a,{children:e.jsxs(t.p,{children:[e.jsx(n,{children:"message: string"})," — A human-readable description of the error."]})}),e.jsx(a,{children:e.jsxs(t.p,{children:[e.jsx(n,{children:"stack_trace: string"}),` — The call-stack snapshot captured when the exception
was thrown.`]})})]}),`
`,e.jsx(r,{children:e.jsxs(t.p,{children:["Any class or struct that implements ",e.jsx(n,{children:"IThrowable"}),` can be thrown and caught.
...
`,e.jsx(r,{children:e.jsxs(t.p,{children:[e.jsx("strong",{children:"Typed versus catch-all clauses."}),` Use typed catches for code paths that need to
...
`,e.jsx(r,{children:e.jsxs(t.p,{children:[e.jsx("strong",{children:"Rethrow semantics."})," Inside a catch body, ",e.jsx(n,{children:"throw;"}),` re-raises
...
`,e.jsx(r,{children:e.jsxs(t.p,{children:[e.jsxs("strong",{children:["Stack unwinding and ",e.jsx(n,{children:"defer"}),"."]}),` When an exception is thrown, the
...
cleanup.`]})}),`
`,e.jsx(r,{children:e.jsxs(t.p,{children:[e.jsx("strong",{children:"Async methods."})," Exceptions thrown inside an ",e.jsx(n,{children:"async"}),` method are
...
points.`]})}),`
`,e.jsx(r,{children:e.jsxs(t.p,{children:[e.jsx("strong",{children:"VM lowering."})," The compiler emits ",e.jsx(n,{children:"ENTER_TRY"}),` to register a
...
`,e.jsx(l,{tone:"amber",title:"finally blocks are not implemented",children:e.jsxs(t.p,{children:["ShardScript does not yet support ",e.jsx(n,{children:"finally"})," blocks. Use"," ",`
...
`,e.jsx(r,{children:e.jsx("strong",{children:"Basic try/catch with RuntimeException."})}),`
...
`,e.jsx(r,{children:"Expected output:"}),`
`,e.jsx(i,{code:`before throw
caught RuntimeException
after catch`,language:"plaintext",filename:"output.txt"}),`
`,e.jsx(r,{children:e.jsx("strong",{children:"Typed catches, IThrowable, and catch-all."})}),`
`,e.jsx(i,{code:`using stdio;
...
`,e.jsx(r,{children:e.jsx("strong",{children:"Rethrow to preserve the original failure."})}),`
`,e.jsx(i,{code:`using stdio;
...
`,e.jsx(r,{children:e.jsx("strong",{children:"Catch-all and inspecting the message."})}),`
`,e.jsx(i,{code:`using stdio;
...
`,e.jsx(r,{children:"Expected output (message content may be empty for a bare RuntimeException):"}),`
`,e.jsx(i,{code:"caught: ",language:"plaintext",filename:"output.txt"}),`
`,e.jsx(r,{children:e.jsx("strong",{children:"Stack unwinding with defer."})}),`
`,e.jsx(i,{code:`using stdio;
...
`,e.jsx(r,{children:e.jsx("strong",{children:"Async exception propagation."})}),`
`,e.jsx(i,{code:`using stdio;
using async;
...
`,e.jsx(r,{children:e.jsx("strong",{children:"Common mistake: catching a base type before a derived type."})}),`
`,e.jsx(i,{code:`using stdio;
...
`,e.jsx(l,{tone:"blue",children:e.jsxs(t.p,{children:["The commented-out ",e.jsx(n,{children:"DerivedException"}),` handler is unreachable because the
...
`,e.jsx(r,{children:e.jsx("strong",{children:"Common mistake: using throw ex instead of throw."})}),`
`,e.jsx(i,{code:`using stdio;
...
}`,language:"csharp",filename:"throw_ex_mistake.shard"})]})}function p(c={}){const{wrapper:t}=c.components||{};return t?e.jsx(t,{...c,children:e.jsx(d,{...c})}):d(c)}function o(c,t){throw new Error("Expected component `"+c+"` to be defined: you likely forgot to import, pass, or provide it.")}export{p as default};
