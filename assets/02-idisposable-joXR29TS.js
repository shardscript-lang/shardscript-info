import{j as e}from"./index-BsFLGxt-.js";function h(t){const n={br:"br",p:"p",...t.components},{Bullet:r,Callout:c,CodeBlock:a,DocsTable:d,H2:o,InlineCode:s,Prose:i}=n;return r||l("Bullet"),c||l("Callout"),a||l("CodeBlock"),d||l("DocsTable"),o||l("H2"),s||l("InlineCode"),i||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(o,{children:"Summary"}),`
