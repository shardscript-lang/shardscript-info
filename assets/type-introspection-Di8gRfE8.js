import{j as e}from"./index-OPpZgTHq.js";function p(i){const n={code:"code",p:"p",...i.components},{Bullet:o,Callout:d,CodeBlock:s,DocsTable:a,H2:l,InlineCode:r,Prose:t}=n;return o||c("Bullet"),d||c("Callout"),s||c("CodeBlock"),a||c("DocsTable"),l||c("H2"),r||c("InlineCode"),t||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(l,{children:"Summary"}),`
