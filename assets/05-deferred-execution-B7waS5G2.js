import{j as e}from"./index-Dw_NxEHJ.js";function h(i){const r={p:"p",...i.components},{Bullet:d,Callout:c,CodeBlock:s,DocsTable:l,H2:a,InlineCode:n,Prose:t}=r;return d||o("Bullet"),c||o("Callout"),s||o("CodeBlock"),l||o("DocsTable"),a||o("H2"),n||o("InlineCode"),t||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:"Summary"}),`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(d,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Empty defer"})," — ",e.jsx(n,{children:"defer;"})," ",`
with no statement is a parse error: "defer statement cannot be empty".`]})}),e.jsx(d,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Defer outside a block"}),` — The emitter reports an
error if `,e.jsx(n,{children:"defer"}),` is not inside a statements block, because there is no
scope boundary to drain it.`]})}),e.jsx(d,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Non-disposable resource defer"}),` — A variable
declaration in `,e.jsx(n,{children:"defer"})," requires the type to implement"," ",`
`,e.jsx(n,{children:"IDisposable"}),"; otherwise semantic analysis fails."]})}),e.jsx(d,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Missing Dispose implementation"}),` — The type must
provide an implementation for `,e.jsx(n,{children:"IDisposable.Dispose()"}),"."]})}),e.jsx(d,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Exception inside a defer"}),` — If a deferred
...
local variables before deferring if you need snapshot semantics.`]})})]})}function x(i={}){const{wrapper:r}=i.components||{};return r?e.jsx(r,{...i,children:e.jsx(h,{...i})}):h(i)}function o(i,r){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{x as default};
