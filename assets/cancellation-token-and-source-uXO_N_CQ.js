import{j as e}from"./index-B-x28vAk.js";function h(l){const a={em:"em",p:"p",...l.components},{Bullet:i,Callout:r,CodeBlock:o,DocsTable:d,H2:s,InlineCode:n,Prose:t}=a;return i||c("Bullet"),r||c("Callout"),o||c("CodeBlock"),d||c("DocsTable"),s||c("H2"),n||c("InlineCode"),t||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(i,{children:e.jsxs(a.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Null source reference"}),` — A token whose source
field is `,e.jsx(n,{children:"null"})," reports ",e.jsx(n,{children:"CanBeCanceled = false"})," ",`
and `,e.jsx(n,{children:"IsCancellationRequested = false"}),". It never throws on its own."]})}),e.jsx(i,{children:e.jsxs(a.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Operation canceled by I/O"}),` — Async I/O methods
...
is already canceled or becomes canceled during the operation.`]})}),e.jsx(i,{children:e.jsxs(a.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Double cancel"})," — Calling"," ",`
...
`,e.jsx(n,{children:"IsCancellationRequested"}),", it continues until it finishes on its own."]})}),`
`,e.jsx(s,{children:"See also"}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(i,{children:e.jsxs(a.p,{children:[e.jsx(n,{children:"TaskCompletionSource<T>"})," — manual completion of async operations."]})}),e.jsx(i,{children:e.jsxs(a.p,{children:[e.jsx(n,{children:"Stream Interfaces"})," — async I/O overloads that accept ",e.jsx(n,{children:"CancellationToken"}),"."]})})]}),`
`,e.jsx(s,{children:"Source"}),`
`,e.jsx(t,{children:e.jsxs(a.p,{children:["The ",e.jsx(n,{children:"shard.async"})," cancellation model ships as part of"," ",`
`,e.jsx(n,{children:"ShardScript.Framework"}),". The native binding for"," ",`
`,e.jsx(n,{children:"CancellationTokenSource"})," and ",e.jsx(n,{children:"CancellationToken"})," is in"," ",`
`,e.jsx(n,{children:"ShardScript.Framework/system/async.shard.cpp"}),"."]})})]})}function p(l={}){const{wrapper:a}=l.components||{};return a?e.jsx(a,{...l,children:e.jsx(h,{...l})}):h(l)}function c(l,a){throw new Error("Expected component `"+l+"` to be defined: you likely forgot to import, pass, or provide it.")}export{p as default};
