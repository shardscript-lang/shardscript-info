import{j as e}from"./index-BsFLGxt-.js";function d(r){const n={p:"p",...r.components},{Bullet:o,Callout:l,CodeBlock:i,DocsTable:h,H2:a,InlineCode:s,Prose:t}=n;return o||c("Bullet"),l||c("Callout"),i||c("CodeBlock"),h||c("DocsTable"),a||c("H2"),s||c("InlineCode"),t||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:"Summary"}),`
