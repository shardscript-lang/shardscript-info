import{j as e}from"./index-DIkNH1R5.js";function h(l){const r={p:"p",...l.components},{Bullet:a,Callout:o,CodeBlock:n,DocsTable:c,H2:i,InlineCode:t,Prose:s}=r;return a||d("Bullet"),o||d("Callout"),n||d("CodeBlock"),c||d("DocsTable"),i||d("H2"),t||d("InlineCode"),s||d("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
