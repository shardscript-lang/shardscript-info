import{j as e}from"./index-Cg_ascQj.js";function h(r){const n={code:"code",p:"p",...r.components},{Bullet:a,Callout:c,CodeBlock:l,DocsTable:d,H2:s,InlineCode:t,Prose:i}=n;return a||o("Bullet"),c||o("Callout"),l||o("CodeBlock"),d||o("DocsTable"),s||o("H2"),t||o("InlineCode"),i||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
