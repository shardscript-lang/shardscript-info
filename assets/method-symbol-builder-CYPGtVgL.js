import{j as e}from"./index-DLc5xCYN.js";function h(i){const r={p:"p",...i.components},{Bullet:s,Callout:o,CodeBlock:l,DocsTable:d,H2:a,InlineCode:t,Prose:n}=r;return s||c("Bullet"),o||c("Callout"),l||c("CodeBlock"),d||c("DocsTable"),a||c("H2"),t||c("InlineCode"),n||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:"Summary"}),`
