import{j as e}from"./index-JSRqoYtX.js";function h(i){const n={code:"code",p:"p",...i.components},{Bullet:c,Callout:d,CodeBlock:o,DocsTable:l,H2:r,InlineCode:t,Prose:s}=n;return c||a("Bullet"),d||a("Callout"),o||a("CodeBlock"),l||a("DocsTable"),r||a("H2"),t||a("InlineCode"),s||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(r,{children:"Summary"}),`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(c,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Key already exists"})," — ",e.jsx(t,{children:"Add(key, value)"})," ",`
throws a runtime exception when the key is already present. Use the indexer or guard with`," ",`
`,e.jsx(t,{children:"ContainsKey"})," if you need overwrite semantics."]})}),e.jsx(c,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Key not found"}),` — The indexer getter throws when the requested key
is absent. Always check `,e.jsx(t,{children:"ContainsKey"})," before reading, or be prepared to catch the runtime error."]})}),e.jsx(c,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Type mismatch"}),` — The compiler rejects keys or values whose type does
not match the dictionary's generic arguments. The key type must also be hashable by the runtime.`]})}),e.jsx(c,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Unhashable key"}),` — Custom reference types use identity hashing
...
public static func Main() -> void
{
  ...
  counts.Add(2, "two");
  println(counts.Count);
}`,language:"csharp",filename:"dictionary_edgecases.shard"})]})}function y(i={}){const{wrapper:n}=i.components||{};return n?e.jsx(n,{...i,children:e.jsx(h,{...i})}):h(i)}function a(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{y as default};
