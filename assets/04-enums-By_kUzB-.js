import{j as e}from"./index-B-x28vAk.js";function u(r){const n={code:"code",p:"p",...r.components},{Bullet:l,Callout:d,CodeBlock:o,DocsTable:c,H2:t,InlineCode:s,Prose:i}=n;return l||a("Bullet"),d||a("Callout"),o||a("CodeBlock"),c||a("DocsTable"),t||a("H2"),s||a("InlineCode"),i||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(t,{children:"Summary"}),`
