import{j as e}from"./index-BsFLGxt-.js";function d(i){const t={p:"p",...i.components},{Bullet:s,CodeBlock:o,DocsTable:a,H2:l,InlineCode:n,Prose:r}=t;return s||c("Bullet"),o||c("CodeBlock"),a||c("DocsTable"),l||c("H2"),n||c("InlineCode"),r||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(l,{children:"Summary"}),`
