import{j as e}from"./index-Dw_NxEHJ.js";function h(a){const r={p:"p",...a.components},{Bullet:s,Callout:o,CodeBlock:l,DocsTable:d,H2:i,InlineCode:n,Prose:t}=r;return s||c("Bullet"),o||c("Callout"),l||c("CodeBlock"),d||c("DocsTable"),i||c("H2"),n||c("InlineCode"),t||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
