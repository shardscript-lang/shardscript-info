import{j as e}from"./index-DLc5xCYN.js";function h(t){const s={code:"code",p:"p",...t.components},{Bullet:o,Callout:a,CodeBlock:d,DocsTable:l,H2:i,InlineCode:n,Prose:r}=s;return o||c("Bullet"),a||c("Callout"),d||c("CodeBlock"),l||c("DocsTable"),i||c("H2"),n||c("InlineCode"),r||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
