import{j as e}from"./index-IfqX08ny.js";function h(r){const n={code:"code",p:"p",...r.components},{Bullet:l,Callout:o,CodeBlock:d,DocsTable:c,H2:s,InlineCode:t,Prose:a}=n;return l||i("Bullet"),o||i("Callout"),d||i("CodeBlock"),c||i("DocsTable"),s||i("H2"),t||i("InlineCode"),a||i("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
