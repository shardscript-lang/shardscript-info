import{j as e}from"./index-JSRqoYtX.js";function h(s){const n={code:"code",p:"p",...s.components},{Bullet:o,Callout:c,CodeBlock:r,DocsTable:d,H2:a,InlineCode:t,Prose:i}=n;return o||l("Bullet"),c||l("Callout"),r||l("CodeBlock"),d||l("DocsTable"),a||l("H2"),t||l("InlineCode"),i||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:"Summary"}),`
