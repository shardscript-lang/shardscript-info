import{j as e}from"./index-B-x28vAk.js";function h(o){const n={p:"p",...o.components},{Bullet:i,Callout:d,CodeBlock:a,DocsTable:l,H2:r,InlineCode:t,Prose:s}=n;return i||c("Bullet"),d||c("Callout"),a||c("CodeBlock"),l||c("DocsTable"),r||c("H2"),t||c("InlineCode"),s||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(r,{children:"Summary"}),`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(i,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Namespace import required"})," — The"," ",`
`,e.jsx(t,{children:"net"})," namespace must be imported with ",e.jsx(t,{children:"using net;"})," ",`
before `,e.jsx(t,{children:"HttpClient"})," or ",e.jsx(t,{children:"HttpResponse"})," can be referenced."]})}),e.jsx(i,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Argument type mismatch"}),` — The constructor and every
method expect `,e.jsx(t,{children:"string"}),` arguments. Passing other primitive types or reference
types fails semantic analysis.`]})}),e.jsx(i,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Connection failure"}),` — If the underlying TCP connection
cannot be established, `,e.jsx(t,{children:"Get"})," and ",e.jsx(t,{children:"Post"}),` throw a runtime
exception with a message such as "HTTP Request Failed: Connection".`]})}),e.jsx(i,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Request timeout"}),` — The client enforces a 5-second
connection timeout and a 5-second read timeout. Exceeding either throws a runtime exception.`]})}),e.jsx(i,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Use after dispose"})," — Calling ",e.jsx(t,{children:"Get"}),`,
`,e.jsx(t,{children:"Post"}),", or reusing the client after ",e.jsx(t,{children:"Dispose()"}),` throws
"HttpClient: Client is disposed.".`]})}),e.jsx(i,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"HTTP-level errors are not exceptions"}),` — Status codes
...
public static func Main() -> void
{
  ...
  response: HttpResponse = client.Get("/api/status");
  println(response.StatusCode);
}`,language:"csharp",filename:"httpclient_scope.shard"}),`
`,e.jsx(r,{children:"See also"}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(i,{children:e.jsxs(n.p,{children:[e.jsx(t,{children:"HttpServer"})," — creating HTTP servers to test client calls against."]})}),e.jsx(i,{children:e.jsxs(n.p,{children:[e.jsx(t,{children:"TCP Sockets"})," — low-level network streams used by the HTTP client."]})})]}),`
`,e.jsx(r,{children:"Source"}),`
`,e.jsx(s,{children:e.jsxs(n.p,{children:["The ",e.jsx(t,{children:"shard.http"})," implementation ships as part of"," ",`
`,e.jsx(t,{children:"ShardScript.Framework"}),". The native binding for ",e.jsx(t,{children:"HttpClient"}),","," ",`
`,e.jsx(t,{children:"HttpResponse"}),", and related helpers is in"," ",`
`,e.jsx(t,{children:"ShardScript.Framework/system/http.shard.cpp"}),"."]})})]})}function u(o={}){const{wrapper:n}=o.components||{};return n?e.jsx(n,{...o,children:e.jsx(h,{...o})}):h(o)}function c(o,n){throw new Error("Expected component `"+o+"` to be defined: you likely forgot to import, pass, or provide it.")}export{u as default};
