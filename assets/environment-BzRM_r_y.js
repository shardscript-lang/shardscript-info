import{j as e}from"./index-DLc5xCYN.js";function h(a){const i={em:"em",p:"p",...a.components},{Bullet:l,Callout:d,CodeBlock:t,DocsTable:c,H2:r,InlineCode:n,Prose:s}=i;return l||o("Bullet"),d||o("Callout"),t||o("CodeBlock"),c||o("DocsTable"),r||o("H2"),n||o("InlineCode"),s||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(r,{children:"Summary"}),`
...
`,e.jsx(c,{headers:["Member","Return Type","Description"],rows:[[e.jsx(n,{children:"Environment.NAME"}),"string","The variable value, or an empty string if the variable does not exist."],[e.jsx(n,{children:"GetVariable(name)"}),"string","The variable value, or an empty string if the variable does not exist."],[e.jsx(n,{children:"SetVariable(name, value)"}),"string","The current implementation returns an empty string."]]}),`
...
}`,language:"csharp",filename:"environment_scope.shard"}),`
`,e.jsx(r,{children:"See also"}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(l,{children:e.jsxs(i.p,{children:[e.jsx(n,{children:"Process & ProcessStartInfo"})," — launching processes that inherit environment variables."]})}),e.jsx(l,{children:e.jsxs(i.p,{children:[e.jsx(n,{children:"I/O & Lifecycle"})," — using custom environment variables with child processes."]})})]}),`
`,e.jsx(r,{children:"Source"}),`
`,e.jsx(s,{children:e.jsxs(i.p,{children:["The ",e.jsx(n,{children:"shard.environment"})," implementation ships as part of"," ",`
`,e.jsx(n,{children:"ShardScript.Framework"}),". The native binding for"," ",`
`,e.jsx(n,{children:"Environment.GetVariable"}),", ",e.jsx(n,{children:"Environment.SetVariable"}),`, and the
static delimiter operator is in `,e.jsx(n,{children:"ShardScript.Framework/system/environment.shard.cpp"}),"."]})})]})}function p(a={}){const{wrapper:i}=a.components||{};return i?e.jsx(i,{...a,children:e.jsx(h,{...a})}):h(a)}function o(a,i){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}export{p as default};
