import{j as e}from"./index-DIkNH1R5.js";function h(t){const s={code:"code",p:"p",...t.components},{Bullet:o,Callout:l,CodeBlock:d,DocsTable:a,H2:i,InlineCode:n,Prose:r}=s;return o||c("Bullet"),l||c("Callout"),d||c("CodeBlock"),a||c("DocsTable"),i||c("H2"),n||c("InlineCode"),r||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
