import{j as e}from"./index-DIkNH1R5.js";function d(c){const r={p:"p",...c.components},{Bullet:a,Callout:l,CodeBlock:i,DocsTable:h,H2:s,InlineCode:n,Prose:t}=r;return a||o("Bullet"),l||o("Callout"),i||o("CodeBlock"),h||o("DocsTable"),s||o("H2"),n||o("InlineCode"),t||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
