import{j as e}from"./index-BQw6jbtc.js";function h(a){const s={p:"p",...a.components},{Bullet:r,Callout:o,CodeBlock:i,DocsTable:d,H2:l,InlineCode:n,Prose:t}=s;return r||c("Bullet"),o||c("Callout"),i||c("CodeBlock"),d||c("DocsTable"),l||c("H2"),n||c("InlineCode"),t||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(l,{children:"Introduction"}),`
...
}`,language:"csharp",filename:"gc_arrays.shard"}),`
`,e.jsx(l,{children:"Related articles"}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(r,{children:e.jsxs(s.p,{children:[e.jsx(n,{children:"syntax/resource-management/object-lifetime"})," — how value types, reference types, scopes, captures, and async state machines determine when an object is alive."]})}),e.jsx(r,{children:e.jsxs(s.p,{children:[e.jsx(n,{children:"common-language-features/defer-and-idisposable"})," — deterministic cleanup for unmanaged resources through ",e.jsx(n,{children:"defer"})," and ",e.jsx(n,{children:"IDisposable"}),"."]})}),e.jsx(r,{children:e.jsxs(s.p,{children:[e.jsx(n,{children:"library-building/native-handles-and-object-lifetime"})," — wrapping native pointers in managed objects and keeping them alive across async boundaries."]})}),e.jsx(r,{children:e.jsxs(s.p,{children:[e.jsx(n,{children:"library-building/garbage-collection-rules"})," — the full lifetime contract for native-library callbacks and return values."]})})]})]})}function p(a={}){const{wrapper:s}=a.components||{};return s?e.jsx(s,{...a,children:e.jsx(h,{...a})}):h(a)}function c(a,s){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}export{p as default};
