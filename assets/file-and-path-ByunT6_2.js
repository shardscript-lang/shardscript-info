import{j as e}from"./index-B-x28vAk.js";function h(l){const n={code:"code",p:"p",...l.components},{Bullet:r,Callout:c,CodeBlock:a,DocsTable:d,H2:s,InlineCode:t,Prose:i}=n;return r||o("Bullet"),c||o("Callout"),a||o("CodeBlock"),d||o("DocsTable"),s||o("H2"),t||o("InlineCode"),i||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
