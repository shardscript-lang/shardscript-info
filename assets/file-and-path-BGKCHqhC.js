import{j as e}from"./index-DFYo8cca.js";function h(r){const n={code:"code",p:"p",...r.components},{Bullet:a,Callout:c,CodeBlock:l,DocsTable:d,H2:s,InlineCode:t,Prose:i}=n;return a||o("Bullet"),c||o("Callout"),l||o("CodeBlock"),d||o("DocsTable"),s||o("H2"),t||o("InlineCode"),i||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
...
`,e.jsx(d,{headers:["Member","Return Type","Notes"],rows:[[e.jsx(n.code,{children:"File.ReadAllText"}),"string","Content of the file as a wide-character string."],[e.jsx(n.code,{children:"File.WriteAllText"}),"void","No value; the file is created or overwritten."],[e.jsx(n.code,{children:"File.Exists"}),"bool","True for any existing file-system entry, including directories."],[e.jsx(n.code,{children:"File.Delete"}),"void","Silent when the file is already absent."],[e.jsx(n.code,{children:"File.Copy"}),"void","No value; destination is overwritten if it already exists."],[e.jsx(n.code,{children:"File.Move"}),"void","No value; source ceases to exist after a successful call."],[e.jsx(n.code,{children:"Path.Join"}),"string","Joined path with platform-native separators."],[e.jsx(n.code,{children:"Path.GetDirectoryName"}),"string","Parent path string; empty for a bare file name."],[e.jsx(n.code,{children:"Path.GetFileName"}),"string",'Last component, e.g. "readme.txt".'],[e.jsx(n.code,{children:"Path.GetExtension"}),"string",'Extension with dot, e.g. ".txt"; empty when none.']]}),`
`,e.jsx(s,{children:"Exceptions / Errors"}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Failed to open text file"})," —"," ",`
`,e.jsx(t,{children:"ReadAllText"})," or ",e.jsx(t,{children:"WriteAllText"}),` throws when the file
cannot be opened because of missing permissions, a locked handle, or a non-existent parent directory.`]})}),e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"File writing failed"})," —"," ",`
`,e.jsx(t,{children:"WriteAllText"})," throws when the stream reports a failure after writing."]})}),e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Failed to delete file"})," —"," ",`
`,e.jsx(t,{children:"File.Delete"})," throws when the path exists but cannot be removed."]})}),e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Failed to copy file"})," —"," ",`
`,e.jsx(t,{children:"File.Copy"})," throws when the source cannot be read or the destination cannot be written."]})}),e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Source file does not exist or is not a regular file"})," —"," ",`
`,e.jsx(t,{children:"File.Move"})," rejects missing sources or directory sources."]})}),e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Destination path cannot be an existing directory"})," —"," ",`
`,e.jsx(t,{children:"File.Move"})," refuses to overwrite an existing directory with a file."]})}),e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Failed to resolve absolute path"})," —"," ",`
`,e.jsx(t,{children:"Path.GetFullPath"})," throws when the runtime cannot normalize the input."]})})]}),`
...
unsuitable for multi-gigabyte data.`]})})]})}function p(r={}){const{wrapper:n}=r.components||{};return n?e.jsx(n,{...r,children:e.jsx(h,{...r})}):h(r)}function o(r,n){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}export{p as default};
