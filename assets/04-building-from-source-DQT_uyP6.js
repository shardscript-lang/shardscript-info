import{j as e}from"./index-DkFwvLJL.js";function c(t){const n={p:"p",...t.components},{Bullet:i,CodeBlock:d,H2:l,InlineCode:r,Prose:s}=n;return i||a("Bullet"),d||a("CodeBlock"),l||a("H2"),r||a("InlineCode"),s||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(l,{children:"Prerequisites"}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(i,{children:e.jsx(n.p,{children:"A C++20 toolchain: MSVC on Windows or GCC/Clang on Linux."})}),e.jsx(i,{children:e.jsxs(n.p,{children:[e.jsx(r,{children:"CMake"})," 3.20 or later and a compatible generator such as Ninja or Make."]})}),e.jsx(i,{children:e.jsx(n.p,{children:"Git, to clone the ShardScript repository and its third-party dependencies."})}),e.jsx(i,{children:e.jsx(n.p,{children:"Enough disk space for the compiler, VM, standard shards, and optional third-party shards."})})]}),`
