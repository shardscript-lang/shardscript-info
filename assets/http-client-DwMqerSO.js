import{j as e}from"./index-CoWj0v4y.js";function h(r){const n={p:"p",...r.components},{Bullet:a,Callout:d,CodeBlock:i,DocsTable:l,H2:o,InlineCode:t,Prose:s}=n;return a||c("Bullet"),d||c("Callout"),i||c("CodeBlock"),l||c("DocsTable"),o||c("H2"),t||c("InlineCode"),s||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(o,{children:"Summary"}),`
