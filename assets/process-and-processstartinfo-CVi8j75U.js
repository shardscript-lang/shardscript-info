import{j as e}from"./index-DLc5xCYN.js";function h(t){const s={code:"code",p:"p",...t.components},{Bullet:c,Callout:d,CodeBlock:r,DocsTable:a,H2:o,InlineCode:n,Prose:i}=s;return c||l("Bullet"),d||l("Callout"),r||l("CodeBlock"),a||l("DocsTable"),o||l("H2"),n||l("InlineCode"),i||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(o,{children:"Summary"}),`
...
</Prose>`,language:"csharp",filename:"process_quoting.shard"})]})}function p(t={}){const{wrapper:s}=t.components||{};return s?e.jsx(s,{...t,children:e.jsx(h,{...t})}):h(t)}function l(t,s){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{p as default};
