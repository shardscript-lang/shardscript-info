import{j as e}from"./index-BsFLGxt-.js";function d(i){const t={p:"p",...i.components},{Bullet:a,Callout:c,CodeBlock:o,DocsTable:h,H2:l,InlineCode:n,Prose:s}=t;return a||r("Bullet"),c||r("Callout"),o||r("CodeBlock"),h||r("DocsTable"),l||r("H2"),n||r("InlineCode"),s||r("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:e.jsxs(t.p,{children:["ShardScript programs are ",e.jsx("strong",{children:"single-threaded and cooperative"}),". Instead of spawning one OS thread per asynchronous operation, the runtime multiplexes every timer, I/O request, and background offload through one ",e.jsx(n,{children:"libuv"})," event loop. An ",e.jsx(n,{children:"async"})," method runs only while it has work to do; when it reaches an ",e.jsx(n,{children:"await"}),", it yields control back to the loop so other tasks can run. This model gives the appearance of concurrency without locks, race conditions, or preemptive context switches."]})}),`
