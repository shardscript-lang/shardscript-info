import{j as e}from"./index-BugjY_CW.js";function h(s){const n={p:"p",...s.components},{Bullet:a,Callout:d,CodeBlock:i,DocsTable:l,H2:o,InlineCode:t,Prose:r}=n;return a||c("Bullet"),d||c("Callout"),i||c("CodeBlock"),l||c("DocsTable"),o||c("H2"),t||c("InlineCode"),r||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(o,{children:"Summary"}),`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Closed stream"}),` — Any read, write, seek, length
change, capacity change, `,e.jsx(t,{children:"ToArray"}),", or ",e.jsx(t,{children:"GetBuffer"})," ",`
after `,e.jsx(t,{children:"Close"}),"/",e.jsx(t,{children:"Dispose"})," throws."]})}),e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Write to read-only stream"})," — Calling"," ",`
...
created with `,e.jsx(t,{children:"new MemoryStream(buffer)"})," throws."]})}),e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Negative arguments"})," — Negative"," ",`
...
`,e.jsx(t,{children:"Capacity"})," values throw."]})}),e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Invalid seek origin"})," — Passing a"," ",`
`,e.jsx(t,{children:"SeekOrigin"})," other than ",e.jsx(t,{children:"Begin"}),","," ",`
`,e.jsx(t,{children:"Current"}),", or ",e.jsx(t,{children:"End"})," throws."]})}),e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Seek before start"}),` — A seek that results in a
negative Position throws.`]})}),e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Capacity too small"})," — Setting"," ",`
`,e.jsx(t,{children:"Capacity"})," to a value less than the current ",e.jsx(t,{children:"Length"})," ",`
throws.`]})}),e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Canceled async operation"}),` — The cancellation-token
...
}`,language:"csharp",filename:"memory_stream_mistakes.shard"})]})}function m(s={}){const{wrapper:n}=s.components||{};return n?e.jsx(n,{...s,children:e.jsx(h,{...s})}):h(s)}function c(s,n){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}export{m as default};
