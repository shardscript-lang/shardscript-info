import{j as e}from"./index-OPpZgTHq.js";function u(r){const n={code:"code",p:"p",...r.components},{Bullet:i,Callout:d,CodeBlock:o,DocsTable:l,H2:c,InlineCode:t,Prose:s}=n;return i||a("Bullet"),d||a("Callout"),o||a("CodeBlock"),l||a("DocsTable"),c||a("H2"),t||a("InlineCode"),s||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(c,{children:"Summary"}),`
