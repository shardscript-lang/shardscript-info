import{j as e}from"./index-B-x28vAk.js";function h(o){const r={p:"p",...o.components},{Bullet:s,Callout:c,CodeBlock:a,DocsTable:d,H2:t,InlineCode:n,Prose:i}=r;return s||l("Bullet"),c||l("Callout"),a||l("CodeBlock"),d||l("DocsTable"),t||l("H2"),n||l("InlineCode"),i||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(t,{children:"Summary"}),`
...
`,e.jsx(d,{headers:["Category","Operators","Description"],rows:[["Arithmetic",e.jsx(n,{children:"+ - * / % ^"}),"Add, subtract, multiply, divide, modulo, exponentiate"],["Bitwise",e.jsx(n,{children:"& | << >>"}),"AND, OR, left shift, right shift on integral types"],["Logical",e.jsx(n,{children:"! & | and or not"}),"NOT, AND, OR on bool values"],["Comparison",e.jsx(n,{children:"== != < > <= >="}),"Equality and ordering"],["Assignment",e.jsx(n,{children:"="}),"Simple assignment"],["Compound assignment",e.jsx(n,{children:"+= -= *= /= %= ^= &= |="}),"Recognized by the lexer and parser but not yet correctly emitted (expand manually)"]]}),`
`,e.jsx(i,{children:e.jsxs(r.p,{children:["For the complete precedence table, associativity rules, and parser-level details, see the"," ",`
`,e.jsx(n,{children:"operator-precedence"}),` reference page. The tables below focus on operator
purpose and type rules.`]})}),`
...
`,e.jsx(i,{children:e.jsxs(r.p,{children:[e.jsx("strong",{children:"Precedence, parentheses, and edge cases."})," See the"," ",`
`,e.jsx(n,{children:"operator-precedence"})," page for the full table and associativity rules."]})}),`
`,e.jsx(a,{code:`using stdio;
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"operator-precedence"})," — the full precedence and associativity table."]})}),e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"implicit-conversions"}),` — how operands are promoted before operators are
applied.`]})}),e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"Primitive Types"})," — the types that operands may have."]})}),e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"Operator Overloading"})," — defining custom operators on classes and structs."]})}),e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"switch Expressions"})," — using ",e.jsx(n,{children:"is"})," and ",e.jsx(n,{children:"as"})," ",`
for type tests.`]})})]}),`
