import{j as e}from"./index-C1AvCmMi.js";function p(s){const t={p:"p",...s.components},{Bullet:l,Callout:o,CodeBlock:a,DocsTable:d,H2:r,InlineCode:i,Prose:n}=t;return l||c("Bullet"),o||c("Callout"),a||c("CodeBlock"),d||c("DocsTable"),r||c("H2"),i||c("InlineCode"),n||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(r,{children:"Summary"}),`
