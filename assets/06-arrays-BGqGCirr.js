import{j as e}from"./index-B-x28vAk.js";function h(a){const r={code:"code",p:"p",...a.components},{Bullet:s,Callout:d,CodeBlock:l,DocsTable:o,H2:t,InlineCode:n,Prose:i}=r;return s||c("Bullet"),d||c("Callout"),l||c("CodeBlock"),o||c("DocsTable"),t||c("H2"),n||c("InlineCode"),i||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:e.jsxs(r.p,{children:["A ",e.jsx("strong",{children:"ShardScript array"}),` is a fixed-size, homogeneous, indexed
...
`,e.jsx(i,{children:e.jsxs(r.p,{children:["Arrays store a fixed number of elements of a single type ",e.jsx(n,{children:"T"}),`,
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"T"}),` — the element type. Must be a known ShardScript type
such as `,e.jsx(n,{children:"int"}),", ",e.jsx(n,{children:"double"}),","," ",`
`,e.jsx(n,{children:"byte"}),", ",e.jsx(n,{children:"string"}),", ",e.jsx(n,{children:"char"}),`,
or a class/struct type.`]})}),e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"exprN"})," — an expression whose type matches"," ",`
`,e.jsx(n,{children:"T"}),". Every element in a literal must have the same type."]})}),e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"index"})," — an ",e.jsx(n,{children:"int"}),` expression giving
the zero-based position to read or write.`]})}),e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"value"})," — an expression assignable to the array's element type."]})}),e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"lower"}),", ",e.jsx(n,{children:"upper"})," —"," ",`
`,e.jsx(n,{children:"int"}),` expressions defining the bounds of a range. Non-integer
bounds are rejected at compile time.`]})}),e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"item"})," — the loop variable introduced by"," ",`
`,e.jsx(n,{children:"foreach"}),". Its type is inferred from the array's element type."]})}),e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"size"})," — an ",e.jsx(n,{children:"int"}),` expression that specifies how
many elements the new array should hold. The expression is evaluated once at creation time.`]})})]}),`
`,e.jsx(t,{children:"Returns"}),`
`,e.jsx(i,{children:e.jsxs(r.p,{children:["An array literal or range expression evaluates to an object of type"," ",`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx("strong",{children:"Compile error — type mismatch:"})," ",`
`,e.jsx(n,{children:'[1, "two"]'}),` is rejected because the elements do not share
a single type.`]})}),e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx("strong",{children:"Compile error — untyped empty literal:"})," ",`
...
grammar but is not yet implemented in the current compiler.`]})}),e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx("strong",{children:"Compile error — non-int index:"})," indexing with"," ",`
`,e.jsx(n,{children:"double"}),", ",e.jsx(n,{children:"string"}),`, or another
non-integer type is rejected.`]})}),e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx("strong",{children:"Compile error — non-enumerable foreach:"})," ",`
`,e.jsx(n,{children:"foreach"})," requires an expression implementing"," ",`
`,e.jsx(n,{children:"IEnumerable<T>"}),"."]})}),e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx("strong",{children:"Runtime error — index out of range:"}),` reading or writing with an
index outside `,e.jsx(n,{children:"0 .. Length - 1"})," throws"," ",`
`,e.jsx(n,{children:"Array index out of range"}),"."]})}),e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx("strong",{children:"Compile error — non-int array size:"})," ",`
`,e.jsx(n,{children:"new T[size]"})," requires ",e.jsx(n,{children:"size"})," to be an"," ",`
`,e.jsx(n,{children:"int"})," expression."]})}),e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx("strong",{children:"Runtime error — null array access:"})," indexing or reading"," ",`
`,e.jsx(n,{children:"Length"})," on a ",e.jsx(n,{children:"null"}),` array reference
throws `,e.jsx(n,{children:"Cannot access indexer on null instance of type null"}),"."]})})]}),`
`,e.jsx(t,{children:"Remarks"}),`
`,e.jsx(i,{children:e.jsxs(r.p,{children:["Arrays in ShardScript are ",e.jsx("strong",{children:"fixed-size"}),`. Once created, the length
cannot change. For a dynamically sized sequence, use`," ",`
`,e.jsx(n,{children:"List<T>"})," from the ",e.jsx(n,{children:"collections"})," ",`
shard.`]})}),`
`,e.jsx(i,{children:e.jsxs(r.p,{children:[e.jsx("strong",{children:"Sized creation."})," The expression ",e.jsx(n,{children:"new T[size]"}),` allocates a
...
`,e.jsx(i,{children:e.jsxs(r.p,{children:["Every array type implicitly implements"," ",`
...
`,e.jsx(i,{children:e.jsxs(r.p,{children:["Ranges are a compact way to produce an ",e.jsx(n,{children:"int[]"}),". The expression"," ",`
...
`,e.jsx(d,{tone:"blue",children:e.jsxs(r.p,{children:["Range expressions count up or down with a step of ",e.jsx(n,{children:"1"}),`. When
the upper bound is smaller than the lower bound (for example `,e.jsx(n,{children:"3..0"}),`)
the result is a descending array. Custom steps or empty descending ranges still
require a C-style `,e.jsx(n,{children:"for"})," loop or another explicit construction."]})}),`
`,e.jsx(i,{children:e.jsx(r.p,{children:`The VM stores reference-type elements as object references and value-type elements
...
storage.`})}),`
`,e.jsx(i,{children:e.jsxs(r.p,{children:[`Array bounds are checked at runtime. Negative indices are not supported and, because
...
`,e.jsx(i,{children:e.jsx("strong",{children:"Basic literals, indexing, and Length"})}),`
...
`,e.jsx(i,{children:e.jsx("strong",{children:"Sized creation with new"})}),`
`,e.jsx(l,{code:`using stdio;
...
`,e.jsx(i,{children:e.jsx("strong",{children:"Reference-type elements and member access"})}),`
`,e.jsx(l,{code:`using stdio;
...
`,e.jsx(i,{children:e.jsx("strong",{children:"Arrays from ranges"})}),`
`,e.jsx(l,{code:`using stdio;
...
`,e.jsx(i,{children:e.jsx("strong",{children:"Iteration with foreach"})}),`
`,e.jsx(l,{code:`using stdio;
...
`,e.jsx(i,{children:e.jsx("strong",{children:"Common mistakes and edge cases"})}),`
`,e.jsx(l,{code:`using stdio;
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"Lists and Dictionaries"})," — dynamically sized collections."]})}),e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"foreach Loops"})," — iterating arrays and other enumerables."]})}),e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"Operators"})," — arithmetic and comparison operators on array elements."]})})]}),`
`,e.jsx(t,{children:"Source"}),`
`,e.jsx(i,{children:e.jsxs(r.p,{children:[`Arrays are allocated, indexed, and length-queried by the ShardScript virtual machine. The relevant
opcodes and runtime helpers live in `,e.jsx(n,{children:"ShardScript/src/runtime/VirtualMachine.cpp"}),"."]})}),`
...
`,e.jsx(n,{children:"null"})," for reference-element arrays."]})})]})}function p(a={}){const{wrapper:r}=a.components||{};return r?e.jsx(r,{...a,children:e.jsx(h,{...a})}):h(a)}function c(a,r){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}export{p as default};
