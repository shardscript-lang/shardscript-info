import{j as e}from"./index-B-x28vAk.js";function d(s){const r={p:"p",...s.components},{Bullet:a,Callout:l,CodeBlock:i,DocsTable:h,H2:c,InlineCode:t,Prose:n}=r;return a||o("Bullet"),l||o("Callout"),i||o("CodeBlock"),h||o("DocsTable"),c||o("H2"),t||o("InlineCode"),n||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(c,{children:"Summary"}),`
