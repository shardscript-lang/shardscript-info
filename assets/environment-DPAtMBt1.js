import{j as e}from"./index-Cal9F7tC.js";function h(t){const i={em:"em",p:"p",...t.components},{Bullet:l,Callout:d,CodeBlock:r,DocsTable:c,H2:a,InlineCode:n,Prose:s}=i;return l||o("Bullet"),d||o("Callout"),r||o("CodeBlock"),c||o("DocsTable"),a||o("H2"),n||o("InlineCode"),s||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:"Summary"}),`
...
`,e.jsx(c,{headers:["Member","Signature","Access"],rows:[[e.jsx(n,{children:"Environment.NAME"}),e.jsxs(e.Fragment,{children:[e.jsx(n,{children:"Environment."}),e.jsx(i.em,{children:"name"})," ",e.jsx(n,{children:":"})," ",e.jsx(n,{children:"string"})]}),"Static delimiter operator; name is an identifier passed as a string."],[e.jsx(n,{children:'Environment["name"]'}),e.jsxs(e.Fragment,{children:[e.jsx(n,{children:"Environment["}),e.jsx(i.em,{children:"name"}),e.jsx(n,{children:"]"})," ",e.jsx(n,{children:"-> string"})]}),"Static delimiter operator with a string expression."],[e.jsx(n,{children:"GetVariable(name)"}),e.jsx(e.Fragment,{children:e.jsx(n,{children:"static func GetVariable(name: string) -> string"})}),"Explicit static method."],[e.jsx(n,{children:"SetVariable(name, value)"}),e.jsx(e.Fragment,{children:e.jsx(n,{children:"static func SetVariable(name: string, value: string) -> void"})}),"Explicit static method."]]}),`
...
`,e.jsx(c,{headers:["Member","Return Type","Description"],rows:[[e.jsx(n,{children:"Environment.NAME"}),"string","The variable value, or an empty string if the variable does not exist."],[e.jsx(n,{children:'Environment["name"]'}),"string","The variable value, or an empty string if the variable does not exist."],[e.jsx(n,{children:"GetVariable(name)"}),"string","The variable value, or an empty string if the variable does not exist."],[e.jsx(n,{children:"SetVariable(name, value)"}),"void","No value is returned."]]}),`
