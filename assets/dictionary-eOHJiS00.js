import{j as e}from"./index-B-x28vAk.js";function h(r){const n={code:"code",p:"p",...r.components},{Bullet:a,Callout:d,CodeBlock:c,DocsTable:l,H2:i,InlineCode:t,Prose:s}=n;return a||o("Bullet"),d||o("Callout"),c||o("CodeBlock"),l||o("DocsTable"),i||o("H2"),t||o("InlineCode"),s||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
