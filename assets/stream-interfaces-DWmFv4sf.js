import{j as e}from"./index-B-x28vAk.js";function h(t){const n={code:"code",p:"p",...t.components},{Bullet:a,Callout:d,CodeBlock:i,DocsTable:c,H2:o,InlineCode:s,Prose:r}=n;return a||l("Bullet"),d||l("Callout"),i||l("CodeBlock"),c||l("DocsTable"),o||l("H2"),s||l("InlineCode"),r||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(o,{children:"Summary"}),`
...
`,e.jsx(c,{headers:["Member","Parameters","Description"],rows:[[e.jsx(n.code,{children:"Dispose()"}),"none","Closes the stream and releases native resources."]]}),`
...
`,e.jsx(c,{headers:["Member","Parameters","Description"],rows:[[e.jsx(n.code,{children:"Read(buffer, offset, count)"}),e.jsxs(e.Fragment,{children:[e.jsx(n.code,{children:"buffer"}),": byte[], ",e.jsx(n.code,{children:"offset"}),": int, ",e.jsx(n.code,{children:"count"}),": int"]}),"Reads up to count bytes synchronously."],[e.jsx(n.code,{children:"ReadAsync(buffer, offset, count)"}),e.jsxs(e.Fragment,{children:[e.jsx(n.code,{children:"buffer"}),": byte[], ",e.jsx(n.code,{children:"offset"}),": int, ",e.jsx(n.code,{children:"count"}),": int"]}),"Asynchronously reads up to count bytes."],[e.jsx(n.code,{children:"ReadAsync(buffer, offset, count, cancellationToken)"}),e.jsxs(e.Fragment,{children:[e.jsx(n.code,{children:"buffer"}),": byte[], ",e.jsx(n.code,{children:"offset"}),": int, ",e.jsx(n.code,{children:"count"}),": int, ",e.jsx(n.code,{children:"cancellationToken"}),": CancellationToken"]}),"Asynchronous read with cancellation support."]]}),`
`,e.jsx(r,{children:e.jsxs(n.p,{children:[e.jsx("strong",{children:"IWritableStream"})," adds byte-oriented write and flush methods:"]})}),`
`,e.jsx(c,{headers:["Member","Parameters","Description"],rows:[[e.jsx(n.code,{children:"Write(buffer, offset, count)"}),e.jsxs(e.Fragment,{children:[e.jsx(n.code,{children:"buffer"}),": byte[], ",e.jsx(n.code,{children:"offset"}),": int, ",e.jsx(n.code,{children:"count"}),": int"]}),"Writes count bytes from buffer to the stream."],[e.jsx(n.code,{children:"WriteAsync(buffer, offset, count)"}),e.jsxs(e.Fragment,{children:[e.jsx(n.code,{children:"buffer"}),": byte[], ",e.jsx(n.code,{children:"offset"}),": int, ",e.jsx(n.code,{children:"count"}),": int"]}),"Asynchronously writes count bytes."],[e.jsx(n.code,{children:"WriteAsync(buffer, offset, count, cancellationToken)"}),e.jsxs(e.Fragment,{children:[e.jsx(n.code,{children:"buffer"}),": byte[], ",e.jsx(n.code,{children:"offset"}),": int, ",e.jsx(n.code,{children:"count"}),": int, ",e.jsx(n.code,{children:"cancellationToken"}),": CancellationToken"]}),"Asynchronous write with cancellation support."],[e.jsx(n.code,{children:"Flush()"}),"none","Forces any buffered data to the underlying device."],[e.jsx(n.code,{children:"FlushAsync()"}),"none","Asynchronously flushes buffered data."],[e.jsx(n.code,{children:"FlushAsync(cancellationToken)"}),e.jsxs(e.Fragment,{children:[e.jsx(n.code,{children:"cancellationToken"}),": CancellationToken"]}),"Asynchronous flush with cancellation support."]]}),`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Cannot access a closed stream"}),` — Calling
`,e.jsx(s,{children:"Read"}),", ",e.jsx(s,{children:"Write"}),", or ",e.jsx(s,{children:"Seek"}),` after
`,e.jsx(s,{children:"Dispose()"})," or ",e.jsx(s,{children:"Close()"})," throws a runtime exception."]})}),e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Offset and count must be non-negative"}),` — Both
`,e.jsx(s,{children:"Read"})," and ",e.jsx(s,{children:"Write"})," reject negative offsets or counts."]})}),e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Buffer bounds violation"})," — If ",e.jsx(s,{children:"offset + count"})," ",`
exceeds `,e.jsx(s,{children:"buffer.Length"}),", the operation throws rather than silently corrupt memory."]})}),e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Cannot write to a non-writable stream"}),` — A stream created from
a read-only byte array (for example, `,e.jsx(s,{children:"new MemoryStream(buffer)"}),") rejects writes."]})}),e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Cannot seek before the beginning"})," — ",e.jsx(s,{children:"Seek"})," ",`
throws when the resulting position is negative.`]})}),e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Invalid seek origin"})," — Passing a value other than"," ",`
`,e.jsx(s,{children:"Begin"}),", ",e.jsx(s,{children:"Current"}),", or ",e.jsx(s,{children:"End"})," throws."]})}),e.jsx(a,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Operation canceled"}),` — The cancellation-aware async overloads return
...
`,e.jsx(d,{tone:"blue",children:e.jsxs(n.p,{children:["Prefer interface-typed parameters when writing reusable helpers. A function that accepts"," ",`
...
`,e.jsx(d,{tone:"amber",title:"SocketStream is not seekable",children:e.jsxs(n.p,{children:[e.jsx(s,{children:"SocketStream"})," implements ",e.jsx(s,{children:"IReadableStream"})," and"," ",`
...
<Bullet>
  <InlineCode>MemoryStream</InlineCode> — seekable in-memory implementation of the stream contracts.
</Bullet>
<Bullet>
  <InlineCode>BinaryReader &amp; BinaryWriter</InlineCode> — typed adapters for{" "}
  <InlineCode>IReadableStream</InlineCode> and <InlineCode>IWritableStream</InlineCode>.
</Bullet>
<Bullet>
  <InlineCode>StreamReader &amp; StreamWriter</InlineCode> — text adapters for{" "}
  <InlineCode>IReadableStream</InlineCode> and <InlineCode>IWritableStream</InlineCode>.
</Bullet>
<Bullet>
  <InlineCode>TCP Sockets</InlineCode> — network-backed streams that implement the readable/writable interfaces.
</Bullet>
</ul>
...
<Prose>
The <InlineCode>io</InlineCode> stream interfaces are defined and implemented in{" "}
<InlineCode>ShardScript.Framework/system/streams.shard.cpp</InlineCode>. The{" "}
<InlineCode>IDisposable</InlineCode> contract is declared alongside other runtime interfaces in the
framework registration code.
</Prose>`,language:"csharp",filename:"stream_read_count.shard"})]})}function u(t={}){const{wrapper:n}=t.components||{};return n?e.jsx(n,{...t,children:e.jsx(h,{...t})}):h(t)}function l(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{u as default};
