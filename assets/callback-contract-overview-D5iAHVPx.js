import{j as e}from"./index-DIkNH1R5.js";function h(a){const t={p:"p",...a.components},{Bullet:r,Callout:o,CodeBlock:l,DocsTable:d,H2:i,InlineCode:n,Prose:s}=t;return r||c("Bullet"),o||c("Callout"),l||c("CodeBlock"),d||c("DocsTable"),i||c("H2"),n||c("InlineCode"),s||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
