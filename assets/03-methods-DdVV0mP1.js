import{j as e}from"./index-hFDFiLgA.js";function h(s){const n={p:"p",...s.components},{Bullet:o,Callout:l,CodeBlock:i,DocsTable:d,H2:a,InlineCode:t,Prose:r}=n;return o||c("Bullet"),l||c("Callout"),i||c("CodeBlock"),d||c("DocsTable"),a||c("H2"),t||c("InlineCode"),r||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:"Summary"}),`
