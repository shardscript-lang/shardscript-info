import{j as e}from"./index-DkFwvLJL.js";function h(t){const s={code:"code",p:"p",...t.components},{Bullet:o,Callout:a,CodeBlock:d,DocsTable:l,H2:i,InlineCode:n,Prose:r}=s;return o||c("Bullet"),a||c("Callout"),d||c("CodeBlock"),l||c("DocsTable"),i||c("H2"),n||c("InlineCode"),r||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
...
`,e.jsx(a,{tone:"blue",children:e.jsxs(s.p,{children:[`The native subprocess layer always enables asynchronous I/O internally so that blocking reads
...
`,e.jsx(a,{tone:"amber",title:"Common mistake: reading after dispose",children:e.jsxs(s.p,{children:["Do not call ",e.jsx(n,{children:"ReadToEnd"})," or ",e.jsx(n,{children:"Kill"}),` after the deferred
...
<Bullet>
  <InlineCode>Process &amp; ProcessStartInfo</InlineCode> — launching processes and configuring start-info fields.
</Bullet>
<Bullet>
  <InlineCode>Environment</InlineCode> — reading and writing environment variables passed to child processes.
</Bullet>
<Bullet>
  <InlineCode>Console I/O</InlineCode> — <InlineCode>stdio</InlineCode> helpers for printing captured output.
</Bullet>
</ul>
...
binding for <InlineCode>Process</InlineCode>, <InlineCode>ProcessStartInfo</InlineCode>, and related I/O helpers
is in <InlineCode>ShardScript.Framework/system/subprocess.shard.cpp</InlineCode>.
</Prose>`,language:"csharp",filename:"subprocess_simple.shard"})]})}function x(t={}){const{wrapper:s}=t.components||{};return s?e.jsx(s,{...t,children:e.jsx(h,{...t})}):h(t)}function c(t,s){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{x as default};
