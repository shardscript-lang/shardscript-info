import{j as e}from"./index-OPpZgTHq.js";function h(i){const r={code:"code",p:"p",...i.components},{Bullet:c,Callout:l,CodeBlock:a,DocsTable:d,H2:s,InlineCode:t,Prose:n}=r;return c||o("Bullet"),l||o("Callout"),a||o("CodeBlock"),d||o("DocsTable"),s||o("H2"),t||o("InlineCode"),n||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
