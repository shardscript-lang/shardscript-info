import{j as e}from"./index-DLc5xCYN.js";function h(l){const n={p:"p",...l.components},{Bullet:r,Callout:o,CodeBlock:a,DocsTable:d,H2:i,InlineCode:s,Prose:t}=n;return r||c("Bullet"),o||c("Callout"),a||c("CodeBlock"),d||c("DocsTable"),i||c("H2"),s||c("InlineCode"),t||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
