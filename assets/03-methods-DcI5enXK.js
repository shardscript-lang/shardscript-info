import{j as e}from"./index-BQw6jbtc.js";function h(o){const t={p:"p",...o.components},{Bullet:i,Callout:l,CodeBlock:s,DocsTable:d,H2:a,InlineCode:n,Prose:r}=t;return i||c("Bullet"),l||c("Callout"),s||c("CodeBlock"),d||c("DocsTable"),a||c("H2"),n||c("InlineCode"),r||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:"Summary"}),`
