import{j as e}from"./index-DkFwvLJL.js";function h(i){const n={p:"p",...i.components},{Bullet:s,Callout:d,CodeBlock:o,DocsTable:l,H2:a,InlineCode:t,Prose:r}=n;return s||c("Bullet"),d||c("Callout"),o||c("CodeBlock"),l||c("DocsTable"),a||c("H2"),t||c("InlineCode"),r||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:"Summary"}),`
