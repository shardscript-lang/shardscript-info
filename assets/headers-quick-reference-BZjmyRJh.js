import{j as e}from"./index-C1AvCmMi.js";function o(i){const n={p:"p",...i.components},{Bullet:s,Callout:d,CodeBlock:c,DocsTable:h,H2:a,InlineCode:r,Prose:t}=n;return s||l("Bullet"),d||l("Callout"),c||l("CodeBlock"),h||l("DocsTable"),a||l("H2"),r||l("InlineCode"),t||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:"Summary"}),`
