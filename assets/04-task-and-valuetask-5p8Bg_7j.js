import{j as e}from"./index-B-x28vAk.js";function h(i){const n={p:"p",...i.components},{Bullet:c,Callout:d,CodeBlock:t,DocsTable:o,H2:r,InlineCode:s,Prose:a}=n;return c||l("Bullet"),d||l("Callout"),t||l("CodeBlock"),o||l("DocsTable"),r||l("H2"),s||l("InlineCode"),a||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(r,{children:"Summary"}),`
