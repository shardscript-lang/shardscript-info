import{j as e}from"./index-B-x28vAk.js";function d(i){const n={p:"p",...i.components},{Bullet:t,DocsTable:c,H2:r,InlineCode:s,Prose:a}=n;return t||o("Bullet"),c||o("DocsTable"),r||o("H2"),s||o("InlineCode"),a||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(r,{children:"Summary"}),`
...
impractical.`]})}),e.jsx(t,{children:e.jsxs(n.p,{children:[e.jsx(s,{children:"Garbage Collection"})," — the memory model that replaces manual management."]})})]})]})}function h(i={}){const{wrapper:n}=i.components||{};return n?e.jsx(n,{...i,children:e.jsx(d,{...i})}):d(i)}function o(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{h as default};
