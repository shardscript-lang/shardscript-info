import{j as e}from"./index-B-x28vAk.js";function h(a){const s={code:"code",p:"p",...a.components},{Bullet:o,Callout:d,CodeBlock:t,DocsTable:c,H2:i,InlineCode:n,Prose:r}=s;return o||l("Bullet"),d||l("Callout"),t||l("CodeBlock"),c||l("DocsTable"),i||l("H2"),n||l("InlineCode"),r||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
...
`,e.jsx(n,{children:"debug"}),` namespace exposes runtime heap and stack snapshots from inside
...
`,e.jsx(r,{children:e.jsxs(s.p,{children:[e.jsx("strong",{children:"Runtime inspection from ShardScript."})," Call the members directly after importing"," ",`
`,e.jsx(n,{children:"debug"}),":"]})}),`
...
`,e.jsx(c,{headers:["Feature","Members / Entry Points"],rows:[["CLI disassembly","shard -d <file>, shard --decompiled <file>"],["C++ disassembler","shard::ProgramDisassembler::Disassemble"],["Runtime frame dump","debug.Debug.PrintStackFrameInfo"],["Runtime heap dump","debug.Debug.PrintGcInfo"]]}),`
`,e.jsx(i,{children:"See also"}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(o,{children:e.jsxs(s.p,{children:[e.jsx(n,{children:"Developer Tools"})," — runtime helpers such as ",e.jsx(n,{children:"PrintStackFrameInfo"})," ",`
and `,e.jsx(n,{children:"PrintGcInfo"}),"."]})}),e.jsx(o,{children:e.jsxs(s.p,{children:[e.jsx(n,{children:"Type Introspection"})," — runtime type inspection that complements bytecode analysis."]})})]}),`
`,e.jsx(i,{children:"Source"}),`
`,e.jsx(r,{children:e.jsxs(s.p,{children:["The ",e.jsx(n,{children:"ProgramDisassembler"})," C++ class is part of the core compiler. Its header is"," ",`
`,e.jsx(n,{children:"ShardScript/include/shard/compilation/ProgramDisassembler.hpp"})," and its implementation is"," ",`
`,e.jsx(n,{children:"ShardScript/src/compilation/ProgramDisassembler.cpp"}),". The runtime ",e.jsx(n,{children:"Debug"})," ",`
helpers are in `,e.jsx(n,{children:"ShardScript.Framework/system/debug.shard.cpp"}),"."]})})]})}function m(a={}){const{wrapper:s}=a.components||{};return s?e.jsx(s,{...a,children:e.jsx(h,{...a})}):h(a)}function l(a,s){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}export{m as default};
