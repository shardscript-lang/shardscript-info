import{j as e}from"./index-OPpZgTHq.js";function h(i){const n={code:"code",p:"p",...i.components},{Bullet:c,Callout:d,CodeBlock:o,DocsTable:l,H2:r,InlineCode:t,Prose:s}=n;return c||a("Bullet"),d||a("Callout"),o||a("CodeBlock"),l||a("DocsTable"),r||a("H2"),t||a("InlineCode"),s||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(r,{children:"Summary"}),`
