import{j as e}from"./index-BQw6jbtc.js";function h(s){const r={code:"code",p:"p",...s.components},{Bullet:o,Callout:l,CodeBlock:c,DocsTable:d,H2:i,InlineCode:t,Prose:n}=r;return o||a("Bullet"),l||a("Callout"),c||a("CodeBlock"),d||a("DocsTable"),i||a("H2"),t||a("InlineCode"),n||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(o,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Create failure"})," —"," ",`
...
because the caller lacks permission).`]})}),e.jsx(o,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Delete failure"})," —"," ",`
...
removal fails.`]})}),e.jsx(o,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Path does not exist"})," —"," ",`
`,e.jsx(t,{children:"DirectoryInfo.Exists"}),` simply returns false; it never throws for a
missing path.`]})}),e.jsx(o,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Invalid path composition"})," — The"," ",`
...
`,e.jsx(t,{children:"DirectoryInfo"})," instance."]})}),`
`,e.jsx(i,{children:"See also"}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(o,{children:e.jsxs(r.p,{children:[e.jsx(t,{children:"File & Path"})," — reading, writing, and parsing file-system paths."]})}),e.jsx(o,{children:e.jsxs(r.p,{children:[e.jsx(t,{children:"Path Concatenation"})," — composing directory and file paths with the ",e.jsx(t,{children:"/"})," operator."]})})]}),`
`,e.jsx(i,{children:"Source"}),`
`,e.jsx(n,{children:e.jsxs(r.p,{children:["The ",e.jsx(t,{children:"shard.filesystem"})," implementation ships as part of"," ",`
`,e.jsx(t,{children:"ShardScript.Framework"}),". The native binding for ",e.jsx(t,{children:"Directory"}),","," ",`
`,e.jsx(t,{children:"DirectoryInfo"}),", and related types is in"," ",`
`,e.jsx(t,{children:"ShardScript.Framework/system/filesystem.shard.cpp"}),"."]})})]})}function x(s={}){const{wrapper:r}=s.components||{};return r?e.jsx(r,{...s,children:e.jsx(h,{...s})}):h(s)}function a(s,r){throw new Error("Expected component `"+s+"` to be defined: you likely forgot to import, pass, or provide it.")}export{x as default};
