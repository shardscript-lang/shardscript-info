import{j as e}from"./index-DkFwvLJL.js";function h(s){const a={p:"p",...s.components},{Bullet:n,Callout:o,CodeBlock:d,DocsTable:c,H2:l,InlineCode:t,Prose:r}=a;return n||i("Bullet"),o||i("Callout"),d||i("CodeBlock"),c||i("DocsTable"),l||i("H2"),t||i("InlineCode"),r||i("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(l,{children:"Summary"}),`
