import{j as e}from"./index-C1AvCmMi.js";function l(a){const s={p:"p",...a.components},{Bullet:o,CodeBlock:d,DocsTable:t,H2:i,InlineCode:n,Prose:r}=s;return o||c("Bullet"),d||c("CodeBlock"),t||c("DocsTable"),i||c("H2"),n||c("InlineCode"),r||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
