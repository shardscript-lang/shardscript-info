import{j as e}from"./index-DkFwvLJL.js";function h(o){const t={code:"code",p:"p",...o.components},{Bullet:r,Callout:l,CodeBlock:i,DocsTable:d,H2:c,InlineCode:n,Prose:s}=t;return r||a("Bullet"),l||a("Callout"),i||a("CodeBlock"),d||a("DocsTable"),c||a("H2"),n||a("InlineCode"),s||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(c,{children:"Summary"}),`
