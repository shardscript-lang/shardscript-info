import{j as e}from"./index-BJYykHK7.js";function m(l){const n={p:"p",...l.components},{Bullet:i,Callout:o,CodeBlock:s,DocsTable:c,H2:a,InlineCode:r,Prose:t}=n;return i||d("Bullet"),o||d("Callout"),s||d("CodeBlock"),c||d("DocsTable"),a||d("H2"),r||d("InlineCode"),t||d("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:"Summary"}),`
