import{j as e}from"./index-BJYykHK7.js";function h(a){const t={p:"p",...a.components},{Bullet:i,Callout:d,CodeBlock:s,DocsTable:o,H2:l,InlineCode:n,Prose:r}=t;return i||c("Bullet"),d||c("Callout"),s||c("CodeBlock"),o||c("DocsTable"),l||c("H2"),n||c("InlineCode"),r||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(l,{children:"Summary"}),`
