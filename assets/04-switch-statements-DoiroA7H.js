import{j as e}from"./index-B-x28vAk.js";function d(i){const s={p:"p",...i.components},{Bullet:r,CodeBlock:l,DocsTable:o,H2:a,InlineCode:n,Prose:t}=s;return r||c("Bullet"),l||c("CodeBlock"),o||c("DocsTable"),a||c("H2"),n||c("InlineCode"),t||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:"Summary"}),`
