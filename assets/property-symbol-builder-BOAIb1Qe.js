import{j as e}from"./index-hFDFiLgA.js";function h(i){const r={p:"p",...i.components},{Bullet:s,Callout:d,CodeBlock:a,DocsTable:o,H2:l,InlineCode:t,Prose:n}=r;return s||c("Bullet"),d||c("Callout"),a||c("CodeBlock"),o||c("DocsTable"),l||c("H2"),t||c("InlineCode"),n||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(l,{children:"Summary"}),`
