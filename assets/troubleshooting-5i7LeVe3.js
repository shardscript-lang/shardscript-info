import{j as e}from"./index-DLc5xCYN.js";function h(i){const n={p:"p",...i.components},{Bullet:s,Callout:o,CodeBlock:a,DocsTable:d,H2:l,InlineCode:t,Prose:r}=n;return s||c("Bullet"),o||c("Callout"),a||c("CodeBlock"),d||c("DocsTable"),l||c("H2"),t||c("InlineCode"),r||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(l,{children:"Summary"}),`
