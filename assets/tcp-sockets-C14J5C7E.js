import{j as e}from"./index-BQw6jbtc.js";function h(o){const t={code:"code",p:"p",...o.components},{Bullet:r,Callout:l,CodeBlock:i,DocsTable:d,H2:c,InlineCode:n,Prose:s}=t;return r||a("Bullet"),l||a("Callout"),i||a("CodeBlock"),d||a("DocsTable"),c||a("H2"),n||a("InlineCode"),s||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(c,{children:"Summary"}),`
...
}`,language:"csharp",filename:"socket_dispose_client.shard"}),`
`,e.jsx(c,{children:"See also"}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(r,{children:e.jsxs(t.p,{children:[e.jsx(n,{children:"Stream Interfaces"})," — ",e.jsx(n,{children:"IReadableStream"})," and"," ",`
`,e.jsx(n,{children:"IWritableStream"})," contracts implemented by ",e.jsx(n,{children:"SocketStream"}),"."]})}),e.jsx(r,{children:e.jsxs(t.p,{children:[e.jsx(n,{children:"BinaryReader & BinaryWriter"})," — typed I/O over a ",e.jsx(n,{children:"SocketStream"}),"."]})}),e.jsx(r,{children:e.jsxs(t.p,{children:[e.jsx(n,{children:"HttpServer"})," and ",e.jsx(n,{children:"HttpClient"})," — higher-level networking APIs."]})})]}),`
`,e.jsx(c,{children:"Source"}),`
`,e.jsx(s,{children:e.jsxs(t.p,{children:["The ",e.jsx(n,{children:"shard.socket"})," implementation ships as part of"," ",`
`,e.jsx(n,{children:"ShardScript.Framework"}),". The native binding for ",e.jsx(n,{children:"Socket"}),","," ",`
`,e.jsx(n,{children:"SocketStream"}),", and related networking helpers is in"," ",`
`,e.jsx(n,{children:"ShardScript.Framework/system/socket.shard.cpp"}),"."]})})]})}function j(o={}){const{wrapper:t}=o.components||{};return t?e.jsx(t,{...o,children:e.jsx(h,{...o})}):h(o)}function a(o,t){throw new Error("Expected component `"+o+"` to be defined: you likely forgot to import, pass, or provide it.")}export{j as default};
