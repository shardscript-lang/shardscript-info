import{j as e}from"./index-B-x28vAk.js";function d(r){const s={p:"p",...r.components},{Bullet:n,CodeBlock:o,DocsTable:l,H2:a,InlineCode:t,Prose:i}=s;return n||c("Bullet"),o||c("CodeBlock"),l||c("DocsTable"),a||c("H2"),t||c("InlineCode"),i||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:"Summary"}),`
