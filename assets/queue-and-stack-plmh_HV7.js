import{j as e}from"./index-DkFwvLJL.js";function h(c){const n={code:"code",p:"p",...c.components},{Bullet:i,Callout:d,CodeBlock:a,DocsTable:l,H2:r,InlineCode:t,Prose:s}=n;return i||o("Bullet"),d||o("Callout"),a||o("CodeBlock"),l||o("DocsTable"),r||o("H2"),t||o("InlineCode"),s||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(r,{children:"Summary"}),`
