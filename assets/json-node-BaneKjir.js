import{j as e}from"./index-DkFwvLJL.js";function h(i){const s={code:"code",em:"em",p:"p",...i.components},{Bullet:o,Callout:l,CodeBlock:d,DocsTable:c,H2:t,InlineCode:n,Prose:r}=s;return o||a("Bullet"),l||a("Callout"),d||a("CodeBlock"),c||a("DocsTable"),t||a("H2"),n||a("InlineCode"),r||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(t,{children:"Summary"}),`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(o,{children:e.jsxs(s.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Invalid JSON"})," —"," ",`
`,e.jsx(n,{children:"JsonNode.Parse"}),` throws a runtime error if the input is malformed,
contains trailing characters, has unterminated strings, or uses invalid escape sequences.`]})}),e.jsx(o,{children:e.jsxs(s.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Set on null node"})," — Calling"," ",`
`,e.jsx(n,{children:"Set"})," on a null/missing node throws because there is no DOM tree to mutate."]})}),e.jsx(o,{children:e.jsxs(s.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Add on null node"})," — Calling"," ",`
`,e.jsx(n,{children:"Add"})," on a null/missing node throws for the same reason."]})}),e.jsx(o,{children:e.jsxs(s.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Nesting depth exceeded"}),` — Both parsing and
serialization enforce a maximum depth of 512 levels to prevent stack overflow on deeply
nested or cyclic structures.`]})}),e.jsx(o,{children:e.jsxs(s.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Non-finite number"})," — Serializing a"," ",`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(o,{children:e.jsxs(s.p,{children:[e.jsx(n,{children:"JsonSerializer"})," — typed serialization and deserialization to and from JSON."]})}),e.jsx(o,{children:e.jsxs(s.p,{children:[e.jsx(n,{children:"Console I/O"})," — ",e.jsx(n,{children:"stdio"})," helpers such as"," ",`
`,e.jsx(n,{children:"println"}),", which can print a ",e.jsx(n,{children:"JsonNode"})," directly."]})})]}),`
`,e.jsx(t,{children:"Source"}),`
`,e.jsx(r,{children:e.jsxs(s.p,{children:["The ",e.jsx(n,{children:"shard.json"})," implementation ships as part of"," ",`
`,e.jsx(n,{children:"ShardScript.Framework"}),". The native binding for"," ",`
`,e.jsx(n,{children:"JsonNode"}),", ",e.jsx(n,{children:"JsonNodeKind"}),", and the shared"," ",`
`,e.jsx(n,{children:"JsonDom"})," tree is in"," ",`
`,e.jsx(n,{children:"ShardScript.Framework/system/json.shard.cpp"}),"."]})})]})}function x(i={}){const{wrapper:s}=i.components||{};return s?e.jsx(s,{...i,children:e.jsx(h,{...i})}):h(i)}function a(i,s){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{x as default};
