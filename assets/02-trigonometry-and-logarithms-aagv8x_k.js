import{j as e}from"./index-BQw6jbtc.js";function h(i){const t={code:"code",p:"p",...i.components},{Bullet:l,Callout:c,CodeBlock:o,DocsTable:d,H2:r,InlineCode:n,Prose:s}=t;return l||a("Bullet"),c||a("Callout"),o||a("CodeBlock"),d||a("DocsTable"),r||a("H2"),n||a("InlineCode"),s||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:e.jsxs(t.p,{children:["All trigonometric and logarithmic functions are ",e.jsx("strong",{children:"direct native wrappers"})," ",`
...
`,e.jsx(r,{children:"Trigonometric Functions"}),`
`,e.jsx(s,{children:e.jsxs(t.p,{children:["The forward trig functions (",e.jsx(n,{children:"Sin"}),", ",e.jsx(n,{children:"Cos"}),","," ",`
...
`,e.jsx(c,{tone:"blue",children:e.jsxs(t.p,{children:[e.jsx(n,{children:"Atan2(y, x)"}),` is the preferred way to compute an angle from
...
`,e.jsx(r,{children:"Logarithms, Exponentiation & Roots"}),`
`,e.jsx(s,{children:e.jsx(t.p,{children:"The exponential and logarithmic family covers power, root, and log operations:"})}),`
...
`,e.jsx(r,{children:"Practical Usage"}),`
`,e.jsx(s,{children:e.jsxs(t.p,{children:[`Combining trigonometry with exponentiation covers most geometric and scientific workloads.
...
the `,e.jsx(n,{children:"std::"})," call."]})})]})]}),`
`,e.jsx(r,{children:"See also"}),`
`,e.jsx("ul",{className:"space-y-2 text-text-secondary",children:e.jsx(l,{children:e.jsxs(t.p,{children:[e.jsx(n,{children:"Basic Math"})," — constants, rounding, and min/max helpers on the ",e.jsx(n,{children:"Math"})," class."]})})}),`
...
`,e.jsx(n,{children:"ShardScript.Framework"}),`. The native binding for the trigonometric, logarithm, power, and root
functions is in `,e.jsx(n,{children:"ShardScript.Framework/system/math.shard.cpp"}),"."]})})]})}function u(i={}){const{wrapper:t}=i.components||{};return t?e.jsx(t,{...i,children:e.jsx(h,{...i})}):h(i)}function a(i,t){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{u as default};
