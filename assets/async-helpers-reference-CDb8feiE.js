import{j as e}from"./index-DLc5xCYN.js";function h(c){const t={p:"p",...c.components},{Bullet:l,Callout:o,CodeBlock:r,DocsTable:i,H2:s,InlineCode:n,Prose:a}=t;return l||d("Bullet"),o||d("Callout"),r||d("CodeBlock"),i||d("DocsTable"),s||d("H2"),n||d("InlineCode"),a||d("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
