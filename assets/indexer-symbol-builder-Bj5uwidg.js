import{j as e}from"./index-B-x28vAk.js";function x(i){const r={p:"p",...i.components},{Bullet:l,Callout:c,CodeBlock:d,DocsTable:o,H2:s,InlineCode:t,Prose:n}=r;return l||a("Bullet"),c||a("Callout"),d||a("CodeBlock"),o||a("DocsTable"),s||a("H2"),t||a("InlineCode"),n||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
