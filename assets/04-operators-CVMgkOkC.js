import{j as e}from"./index-7OQU3gOS.js";function h(t){const r={p:"p",...t.components},{Bullet:s,Callout:c,CodeBlock:a,DocsTable:d,H2:o,InlineCode:n,Prose:i}=r;return s||l("Bullet"),c||l("Callout"),a||l("CodeBlock"),d||l("DocsTable"),o||l("H2"),n||l("InlineCode"),i||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(o,{children:"Summary"}),`
...
`,e.jsx(n,{children:"="})," must be a variable, field, property, or indexer expression."]})}),e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Division by zero"})," — Both integer and floating-point"," ",`
`,e.jsx(n,{children:"/"})," throw when the divisor is zero."]})}),e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Modulo by zero"})," — ",e.jsx(n,{children:"%"})," ",`
throws when the divisor is zero.`]})}),e.jsx(s,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Null operand"}),` — Performing a primitive operation on
...
public static func Main() -> void
{
  ...
  println(-7 % 3);         // -1
}`,language:"csharp",filename:"precedence.shard"})]})}function x(t={}){const{wrapper:r}=t.components||{};return r?e.jsx(r,{...t,children:e.jsx(h,{...t})}):h(t)}function l(t,r){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{x as default};
