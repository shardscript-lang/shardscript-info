import{j as e}from"./index-BQw6jbtc.js";function h(i){const n={p:"p",...i.components},{Bullet:s,Callout:c,CodeBlock:a,DocsTable:o,H2:l,InlineCode:t,Prose:r}=n;return s||d("Bullet"),c||d("Callout"),a||d("CodeBlock"),o||d("DocsTable"),l||d("H2"),t||d("InlineCode"),r||d("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(l,{children:"Summary"}),`
...
`,e.jsx(r,{children:e.jsxs(n.p,{children:["The non-callback ",e.jsx(t,{children:"AddClass"})," overload returns a ",e.jsx(t,{children:"SymbolBuilder<ClassSymbol>"}),"; the callback overload returns ",e.jsx(t,{children:"SymbolBuilder<NamespaceSymbol>&"}),`.
