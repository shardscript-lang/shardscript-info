import{j as e}from"./index-DbYfS1MK.js";function p(r){const n={p:"p",...r.components},{Bullet:t,Callout:d,CodeBlock:a,DocsTable:c,H2:l,InlineCode:i,Prose:s}=n;return t||o("Bullet"),d||o("Callout"),a||o("CodeBlock"),c||o("DocsTable"),l||o("H2"),i||o("InlineCode"),s||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(l,{children:"Summary"}),`
