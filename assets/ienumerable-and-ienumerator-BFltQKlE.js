import{j as e}from"./index-DLc5xCYN.js";function h(l){const r={code:"code",p:"p",...l.components},{Bullet:a,Callout:d,CodeBlock:i,DocsTable:o,H2:s,InlineCode:n,Prose:t}=r;return a||c("Bullet"),d||c("Callout"),i||c("CodeBlock"),o||c("DocsTable"),s||c("H2"),n||c("InlineCode"),t||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(t,{children:e.jsxs(r.p,{children:["The ",e.jsx(n,{children:"shard.collections"}),` library is built on two generic interfaces:
...
`,e.jsx(i,{code:`// Interface signatures (compiler-provided).
...
`,e.jsx(i,{code:`foreach (item in source)
{
  // body
...
`,e.jsx(o,{headers:["Member","Parameters","Returns","Description"],rows:[[e.jsx(r.code,{children:"GetEnumerator()"}),e.jsx(e.Fragment,{}),e.jsx(e.Fragment,{children:e.jsx(n,{children:"IEnumerator<T>"})}),"Returns a new enumerator positioned before the first element of the sequence."]]}),`
`,e.jsx(t,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"IEnumerator<T>"})," members:"]})}),`
`,e.jsx(o,{headers:["Member","Parameters","Returns","Description"],rows:[[e.jsx(r.code,{children:"MoveNext()"}),e.jsx(e.Fragment,{}),e.jsx(e.Fragment,{children:e.jsx(n,{children:"bool"})}),"Advances the cursor to the next element. Returns <InlineCode>true</InlineCode> if a valid element is available; otherwise <InlineCode>false</InlineCode>."],[e.jsx(r.code,{children:"Current"}),e.jsx(e.Fragment,{}),e.jsx(e.Fragment,{children:e.jsx(n,{children:"T"})}),"Gets the element at the current cursor position. Valid only after a successful <InlineCode>MoveNext()</InlineCode> call."]]}),`
`,e.jsx(t,{children:e.jsxs(r.p,{children:["The ",e.jsx(n,{children:"foreach"})," statement accepts these arguments:"]})}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(a,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Loop variable"}),` — A local variable name
that receives the current element. The type is inferred from the enumerator's element
type unless explicitly declared.`]})}),e.jsx(a,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Source expression"}),` — Any expression whose
...
`,e.jsx(o,{headers:["Member","Return Value"],rows:[[e.jsx(r.code,{children:"GetEnumerator()"}),e.jsxs(e.Fragment,{children:[e.jsx(n,{children:"IEnumerator<T>"})," — a fresh cursor positioned before the first element."]})],[e.jsx(r.code,{children:"MoveNext()"}),e.jsxs(e.Fragment,{children:[e.jsx(n,{children:"bool"})," — ",e.jsx(n,{children:"true"})," while elements remain; ",e.jsx(n,{children:"false"})," when the sequence ends."]})],[e.jsx(r.code,{children:"Current"}),e.jsxs(e.Fragment,{children:[e.jsx(n,{children:"T"})," — the element at the current cursor position."]})],[e.jsx(r.code,{children:"foreach"}),e.jsxs(e.Fragment,{children:[e.jsx(n,{children:"void"})," — the statement itself produces no value."]})]]}),`
`,e.jsx(s,{children:"Exceptions / Errors"}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(a,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Type does not implement IEnumerable<T>"}),` —
...
analysis.`]})}),e.jsx(a,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Current before MoveNext"}),` — Accessing
...
the internal index, which is typically `,e.jsx(n,{children:"null"})," or the last valid value."]})}),e.jsx(a,{children:e.jsxs(r.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Invalid generic type argument"}),` — Passing a
...
`,e.jsx(s,{children:"Category Summary"}),`
`,e.jsx(o,{headers:["Feature","Members"],rows:[["IEnumerable<T>","GetEnumerator()"],["IEnumerator<T>","MoveNext(), Current"],["foreach lowering","GetEnumerator() → MoveNext() → Current"],["Built-in implementers","Array, List<T>, Dictionary<K, V>, Queue<T>, Stack<T>"]]}),`
`,e.jsx(s,{children:"See also"}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(a,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"List<T>"})," — dynamic array collection that implements ",e.jsx(n,{children:"IEnumerable<T>"}),"."]})}),e.jsx(a,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"Dictionary<K, V>"})," — hash table collection that implements ",e.jsx(n,{children:"IEnumerable<T>"}),"."]})}),e.jsx(a,{children:e.jsxs(r.p,{children:[e.jsx(n,{children:"Queue & Stack"})," — FIFO and LIFO collections that implement ",e.jsx(n,{children:"IEnumerable<T>"}),"."]})})]}),`
`,e.jsx(s,{children:"Source"}),`
`,e.jsx(t,{children:e.jsxs(r.p,{children:["The ",e.jsx(n,{children:"IEnumerable<T>"})," and ",e.jsx(n,{children:"IEnumerator<T>"}),` interfaces are
registered by the compiler and implemented by the `,e.jsx(n,{children:"shard.collections"}),` library. The concrete
collection registrations and enumerator bindings are in`," ",`
`,e.jsx(n,{children:"ShardScript.Framework/system/collections.shard.cpp"}),"."]})})]})}function m(l={}){const{wrapper:r}=l.components||{};return r?e.jsx(r,{...l,children:e.jsx(h,{...l})}):h(l)}function c(l,r){throw new Error("Expected component `"+l+"` to be defined: you likely forgot to import, pass, or provide it.")}export{m as default};
