import{j as e}from"./index-Cg_ascQj.js";function h(i){const t={code:"code",p:"p",...i.components},{Bullet:r,Callout:l,CodeBlock:c,DocsTable:d,H2:o,InlineCode:n,Prose:s}=t;return r||a("Bullet"),l||a("Callout"),c||a("CodeBlock"),d||a("DocsTable"),o||a("H2"),n||a("InlineCode"),s||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(o,{children:"Summary"}),`
