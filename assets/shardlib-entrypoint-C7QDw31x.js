import{j as e}from"./index-BsFLGxt-.js";function h(a){const r={p:"p",strong:"strong",...a.components},{Bullet:s,Callout:c,CodeBlock:o,DocsTable:l,H2:t,InlineCode:n,Prose:i}=r;return s||d("Bullet"),c||d("Callout"),o||d("CodeBlock"),l||d("DocsTable"),t||d("H2"),n||d("InlineCode"),i||d("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(t,{children:"Summary"}),`
