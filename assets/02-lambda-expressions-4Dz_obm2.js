import{j as e}from"./index-B-x28vAk.js";function h(l){const t={p:"p",...l.components},{Bullet:s,Callout:c,CodeBlock:r,DocsTable:o,H2:i,InlineCode:n,Prose:a}=t;return s||d("Bullet"),c||d("Callout"),r||d("CodeBlock"),o||d("DocsTable"),i||d("H2"),n||d("InlineCode"),a||d("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
