import{j as e}from"./index-hFDFiLgA.js";function h(i){const n={code:"code",p:"p",...i.components},{Bullet:o,Callout:l,CodeBlock:a,DocsTable:c,H2:s,InlineCode:r,Prose:t}=n;return o||d("Bullet"),l||d("Callout"),a||d("CodeBlock"),c||d("DocsTable"),s||d("H2"),r||d("InlineCode"),t||d("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
