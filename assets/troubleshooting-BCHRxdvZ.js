import{j as e}from"./index-BQw6jbtc.js";function h(i){const n={p:"p",...i.components},{Bullet:s,Callout:o,CodeBlock:a,DocsTable:d,H2:l,InlineCode:t,Prose:r}=n;return s||c("Bullet"),o||c("Callout"),a||c("CodeBlock"),d||c("DocsTable"),l||c("H2"),t||c("InlineCode"),r||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(l,{children:"Summary"}),`
...
`,e.jsx(o,{tone:"blue",children:e.jsxs(n.p,{children:[`If a problem is not listed here, check the registration contract first: does the shared library export
...
Browse the directory on GitHub: `,e.jsx(t,{children:"https://github.com/Rikitav/ShardScript/blob/main/ShardScript.Framework/system/"}),"."]})})]})}function x(i={}){const{wrapper:n}=i.components||{};return n?e.jsx(n,{...i,children:e.jsx(h,{...i})}):h(i)}function c(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{x as default};
