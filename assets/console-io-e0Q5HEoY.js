import{j as e}from"./index-hFDFiLgA.js";function h(t){const r={code:"code",p:"p",...t.components},{Bullet:l,Callout:c,CodeBlock:o,DocsTable:d,H2:i,InlineCode:n,Prose:s}=r;return l||a("Bullet"),c||a("Callout"),o||a("CodeBlock"),d||a("DocsTable"),i||a("H2"),n||a("InlineCode"),s||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
