import{j as e}from"./index-BJYykHK7.js";function x(l){const t={p:"p",...l.components},{Bullet:i,Callout:d,CodeBlock:o,DocsTable:h,H2:a,InlineCode:n,Prose:r}=t;return i||c("Bullet"),d||c("Callout"),o||c("CodeBlock"),h||c("DocsTable"),a||c("H2"),n||c("InlineCode"),r||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(r,{children:e.jsxs(t.p,{children:["ShardScript is a ",e.jsx("strong",{children:"compiled"}),` scripting language: source text is never interpreted
