import{j as e}from"./index-DLc5xCYN.js";function p(a){const n={p:"p",...a.components},{Bullet:r,Callout:d,CodeBlock:l,DocsTable:c,H2:t,InlineCode:i,Prose:s}=n;return r||o("Bullet"),d||o("Callout"),l||o("CodeBlock"),c||o("DocsTable"),t||o("H2"),i||o("InlineCode"),s||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(t,{children:"Summary"}),`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(r,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Missing type argument"})," —"," ",`
`,e.jsx(i,{children:"Deserialize<T>"}),` requires an explicit type argument. Omitting it
raises `,e.jsx(i,{children:'"JSON: Deserialize requires a type argument, e.g. Deserialize<Person>(...)"'}),"."]})}),e.jsx(r,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Null text argument"})," — Passing"," ",`
`,e.jsx(i,{children:"null"})," to ",e.jsx(i,{children:"Deserialize<T>"})," raises"," ",`
`,e.jsx(i,{children:'"JSON: Deserialize text is null"'}),"."]})}),e.jsx(r,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Malformed JSON"}),` — Missing quotes, trailing
commas, unterminated strings, or unexpected characters raise`," ",`
`,e.jsx(i,{children:"RuntimeException"})," with a message that includes the parse position."]})}),e.jsx(r,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Root kind mismatch"}),` — Deserializing a JSON
number into a class, or a JSON object into an array, raises`," ",`
`,e.jsx(i,{children:'"JSON: expected object"'})," or"," ",`
`,e.jsx(i,{children:'"JSON: expected array"'}),"."]})}),e.jsx(r,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Non-finite double"})," — Serializing"," ",`
`,e.jsx(i,{children:"double.PositiveInfinity"}),", ",e.jsx(i,{children:"double.NegativeInfinity"}),`,
or `,e.jsx(i,{children:"double.NaN"})," raises"," ",`
`,e.jsx(i,{children:'"JSON: cannot serialize non-finite number"'}),"."]})}),e.jsx(r,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Nesting depth exceeded"}),` — Object graphs deeper
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(r,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Missing keys."}),` Fields without a matching JSON key
...
`,e.jsx(i,{children:'""'})," for strings, and ",e.jsx(i,{children:"null"})," for reference types."]})}),e.jsx(r,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Extra keys."}),` JSON keys that do not match any field
on the target type are silently ignored.`]})}),e.jsx(r,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Primitive coercion."}),` When deserializing into a
...
`,e.jsx(i,{children:"0"}),". Unparseable strings yield the default value instead of throwing."]})}),e.jsx(r,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Reference nulls."}),` A JSON null assigned to a
...
}`,language:"csharp",filename:"json_serializer_private.shard"}),`
`,e.jsx(t,{children:"See also"}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(r,{children:e.jsxs(n.p,{children:[e.jsx(i,{children:"JsonNode"})," — mutable DOM API for JSON documents."]})}),e.jsx(r,{children:e.jsxs(n.p,{children:[e.jsx(i,{children:"Type Introspection"})," — runtime type inspection used by the serializer."]})})]}),`
`,e.jsx(t,{children:"Source"}),`
`,e.jsx(s,{children:e.jsxs(n.p,{children:["The ",e.jsx(i,{children:"shard.json"})," implementation ships as part of"," ",`
`,e.jsx(i,{children:"ShardScript.Framework"}),". The native binding for"," ",`
`,e.jsx(i,{children:"JsonSerializer"})," and the shared parser/writer is in"," ",`
`,e.jsx(i,{children:"ShardScript.Framework/system/json.shard.cpp"}),"."]})})]})}function u(a={}){const{wrapper:n}=a.components||{};return n?e.jsx(n,{...a,children:e.jsx(p,{...a})}):p(a)}function o(a,n){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}export{u as default};
