import{j as e}from"./index-BQw6jbtc.js";function h(r){const n={p:"p",...r.components},{Bullet:i,Callout:d,CodeBlock:c,DocsTable:o,H2:a,InlineCode:s,Prose:t}=n;return i||l("Bullet"),d||l("Callout"),c||l("CodeBlock"),o||l("DocsTable"),a||l("H2"),s||l("InlineCode"),t||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:"Summary"}),`
...
`,e.jsx(c,{code:`// Non-generic class.
...
`,e.jsx(o,{headers:["Modifier","Applies to","Meaning"],rows:[[e.jsx(s,{children:"public"}),"class, member","Accessible from any code that can see the containing namespace."],[e.jsx(s,{children:"private"}),"member","Accessible only inside the declaring class."],[e.jsx(s,{children:"protected"}),"member","Accessible inside the declaring class and derived types (reserved for future inheritance support)."],[e.jsx(s,{children:"internal"}),"class, member","Accessible only within the same compilation unit or assembly boundary (reserved for multi-module builds)."],[e.jsx(s,{children:"export"}),"class, member","Makes the symbol visible across shard boundaries when used in native/host bindings."],[e.jsx(s,{children:"static"}),"class, member","Declares a class or member that belongs to the type itself rather than to any instance."],[e.jsx(s,{children:"async"}),"method","Marks a method as asynchronously lowerable to a state machine."],[e.jsx(s,{children:"extern"}),"method","Declares a method whose implementation is supplied by the host runtime."]]}),`
`,e.jsx(d,{tone:"amber",title:"Class inheritance is not yet implemented",children:e.jsxs(n.p,{children:["ShardScript classes can only implement ",e.jsx("strong",{children:"interfaces"}),` after the
...
inheritance lands.`]})}),`
`,e.jsx(d,{tone:"amber",title:"abstract, sealed, and partial are planned",children:e.jsxs(n.p,{children:["The lexer and parser reserve grammar space for ",e.jsx(s,{children:"abstract"}),","," ",`
...
`,e.jsx(d,{tone:"blue",children:e.jsxs(n.p,{children:["Use explicit ",e.jsx(s,{children:"public"}),` on every class and member you intend
...
`,e.jsx(d,{tone:"amber",title:"What is not yet available",children:e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(i,{children:e.jsxs(n.p,{children:["Class inheritance (",e.jsx(s,{children:"class Derived : Base"}),`) — use
interfaces and composition instead.`]})}),e.jsx(i,{children:e.jsxs(n.p,{children:["Method overriding, ",e.jsx(s,{children:"virtual"}),", and"," ",`
`,e.jsx(s,{children:"override"})," keywords."]})}),e.jsx(i,{children:e.jsxs(n.p,{children:["The ",e.jsx(s,{children:"base"})," keyword for calling base-class members."]})}),e.jsx(i,{children:e.jsxs(n.p,{children:[e.jsx(s,{children:"abstract"})," classes and methods."]})}),e.jsx(i,{children:e.jsxs(n.p,{children:[e.jsx(s,{children:"sealed"})," classes and methods."]})}),e.jsx(i,{children:e.jsxs(n.p,{children:[e.jsx(s,{children:"partial"})," class definitions."]})})]})}),`
`,e.jsx(a,{children:"See also"}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(i,{children:e.jsxs(n.p,{children:[e.jsx(s,{children:"Fields and Properties"})," — instance and static fields, properties, and indexers."]})}),e.jsx(i,{children:e.jsxs(n.p,{children:[e.jsx(s,{children:"Methods"})," — instance and static methods, access modifiers, and overloading."]})}),e.jsx(i,{children:e.jsxs(n.p,{children:[e.jsx(s,{children:"Constructors and Initialization"})," — ",e.jsx(s,{children:"init"})," methods and object creation."]})}),e.jsx(i,{children:e.jsxs(n.p,{children:[e.jsx(s,{children:"Interfaces and Abstractions"})," — contracts that classes can implement."]})})]}),`
`,e.jsx(a,{children:"Source"}),`
`,e.jsx(t,{children:e.jsxs(n.p,{children:["Class declarations are parsed into ",e.jsx(s,{children:"ClassDeclarationSyntax"})," nodes in"," ",`
`,e.jsx(s,{children:"ShardScript/ShardScript/src/parsing/SourceParser.cpp"}),". The syntax node definition is in"," ",`
`,e.jsx(s,{children:"ShardScript/ShardScript/include/shard/parsing/nodes/MemberDeclarations/ClassDeclarationSyntax.hpp"}),"."]})})]})}function m(r={}){const{wrapper:n}=r.components||{};return n?e.jsx(n,{...r,children:e.jsx(h,{...r})}):h(r)}function l(r,n){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}export{m as default};
