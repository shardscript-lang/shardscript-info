import{j as e}from"./index-7OQU3gOS.js";function h(s){const n={p:"p",...s.components},{Bullet:c,Callout:l,CodeBlock:r,DocsTable:d,H2:a,InlineCode:t,Prose:i}=n;return c||o("Bullet"),l||o("Callout"),r||o("CodeBlock"),d||o("DocsTable"),a||o("H2"),t||o("InlineCode"),i||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(a,{children:"Summary"}),`
