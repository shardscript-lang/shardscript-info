import{j as e}from"./index-DLc5xCYN.js";function h(a){const t={p:"p",...a.components},{Bullet:i,Callout:o,CodeBlock:l,DocsTable:d,H2:s,InlineCode:n,Prose:r}=t;return i||c("Bullet"),o||c("Callout"),l||c("CodeBlock"),d||c("DocsTable"),s||c("H2"),n||c("InlineCode"),r||c("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
