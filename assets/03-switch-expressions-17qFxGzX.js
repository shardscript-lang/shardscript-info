import{j as e}from"./index-Dw_NxEHJ.js";function d(c){const s={p:"p",...c.components},{Bullet:i,Callout:l,CodeBlock:a,DocsTable:h,H2:r,InlineCode:n,Prose:t}=s;return i||o("Bullet"),l||o("Callout"),a||o("CodeBlock"),h||o("DocsTable"),r||o("H2"),n||o("InlineCode"),t||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(r,{children:"Summary"}),`
...
`,e.jsx(l,{tone:"amber",title:"switch statement status",children:e.jsxs(s.p,{children:["The imperative ",e.jsx(n,{children:"switch"})," statement (with ",e.jsx(n,{children:"case"})," ",`
labels, block bodies, and fallthrough control) is planned but not yet implemented. Today, use
the `,e.jsx(n,{children:"switch"}),` expression form shown on this page for constant pattern
matching.`]})}),`
