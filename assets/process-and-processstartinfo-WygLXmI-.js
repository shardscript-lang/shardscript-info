import{j as e}from"./index-Dw_NxEHJ.js";function h(t){const s={code:"code",p:"p",...t.components},{Bullet:c,Callout:d,CodeBlock:r,DocsTable:l,H2:o,InlineCode:n,Prose:i}=s;return c||a("Bullet"),d||a("Callout"),r||a("CodeBlock"),l||a("DocsTable"),o||a("H2"),n||a("InlineCode"),i||a("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(o,{children:"Summary"}),`
