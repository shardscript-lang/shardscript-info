import{j as e}from"./index-CoWj0v4y.js";function h(a){const s={p:"p",...a.components},{Bullet:r,Callout:o,CodeBlock:i,DocsTable:d,H2:c,InlineCode:n,Prose:t}=s;return r||l("Bullet"),o||l("Callout"),i||l("CodeBlock"),d||l("DocsTable"),c||l("H2"),n||l("InlineCode"),t||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(c,{children:"Introduction"}),`
