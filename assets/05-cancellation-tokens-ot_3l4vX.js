import{j as e}from"./index-BsFLGxt-.js";function h(s){const t={code:"code",p:"p",...s.components},{Bullet:i,Callout:r,CodeBlock:o,DocsTable:d,H2:c,InlineCode:n,Prose:a}=t;return i||l("Bullet"),r||l("Callout"),o||l("CodeBlock"),d||l("DocsTable"),c||l("H2"),n||l("InlineCode"),a||l("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(c,{children:"Summary"}),`
