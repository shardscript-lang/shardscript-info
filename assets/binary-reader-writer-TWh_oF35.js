import{j as e}from"./index-DLc5xCYN.js";function h(a){const n={code:"code",p:"p",...a.components},{Bullet:s,Callout:l,CodeBlock:d,DocsTable:c,H2:i,InlineCode:r,Prose:t}=n;return s||o("Bullet"),l||o("Callout"),d||o("CodeBlock"),c||o("DocsTable"),i||o("H2"),r||o("InlineCode"),t||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"Summary"}),`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(s,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Unexpected end of stream"})," —"," ",`
`,e.jsx(r,{children:"ReadBytes"}),", ",e.jsx(r,{children:"ReadString"}),`, and every numeric read
throw when fewer bytes than required are available.`]})}),e.jsx(s,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Negative count"})," —"," ",`
`,e.jsx(r,{children:"ReadBytes(count)"})," throws if ",e.jsx(r,{children:"count"})," is negative."]})}),e.jsx(s,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Invalid string length"})," —"," ",`
`,e.jsx(r,{children:"ReadString"})," throws if the 4-byte length prefix is negative."]})}),e.jsx(s,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Object disposed"}),` — Any operation on a reader or
writer after `,e.jsx(r,{children:"Close"})," or ",e.jsx(r,{children:"Dispose"})," throws."]})}),e.jsx(s,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Underlying stream closed"}),` — If the wrapped stream
...
only when the consumer expects `,e.jsx(r,{children:"ReadInt64"}),"."]})}),`
`,e.jsx(i,{children:"See also"}),`
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(s,{children:e.jsxs(n.p,{children:[e.jsx(r,{children:"Stream Interfaces"})," — ",e.jsx(r,{children:"IReadableStream"})," and"," ",`
`,e.jsx(r,{children:"IWritableStream"})," contracts."]})}),e.jsx(s,{children:e.jsxs(n.p,{children:[e.jsx(r,{children:"MemoryStream"})," — byte-array-backed stream for binary round-trips."]})}),e.jsx(s,{children:e.jsxs(n.p,{children:[e.jsx(r,{children:"StreamReader & StreamWriter"})," — text-oriented adapters for streams."]})})]}),`
`,e.jsx(i,{children:"Source"}),`
`,e.jsx(t,{children:e.jsxs(n.p,{children:["The ",e.jsx(r,{children:"BinaryReader"})," and ",e.jsx(r,{children:"BinaryWriter"})," implementation ships as part of"," ",`
`,e.jsx(r,{children:"ShardScript.Framework"}),". The native binding is in"," ",`
`,e.jsx(r,{children:"ShardScript.Framework/system/streams.shard.cpp"}),"."]})})]})}function y(a={}){const{wrapper:n}=a.components||{};return n?e.jsx(n,{...a,children:e.jsx(h,{...a})}):h(a)}function o(a,n){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}export{y as default};
