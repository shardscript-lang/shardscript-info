import{j as e}from"./index-B-x28vAk.js";function h(a){const r={p:"p",...a.components},{Bullet:n,Callout:d,CodeBlock:i,DocsTable:c,H2:l,InlineCode:t,Prose:s}=r;return n||o("Bullet"),d||o("Callout"),i||o("CodeBlock"),c||o("DocsTable"),l||o("H2"),t||o("InlineCode"),s||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(l,{children:"Summary"}),`
