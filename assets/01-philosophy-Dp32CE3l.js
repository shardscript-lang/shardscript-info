import{j as e}from"./index-DbX8E4-q.js";function d(a){const n={p:"p",...a.components},{Bullet:r,Callout:c,DocsTable:l,H2:s,InlineCode:t,Prose:i}=n;return r||o("Bullet"),c||o("Callout"),l||o("DocsTable"),s||o("H2"),t||o("InlineCode"),i||o("Prose"),e.jsxs(e.Fragment,{children:[e.jsx(s,{children:"Summary"}),`
...
compile time.`]})}),`
`,e.jsx(s,{children:"What problem it solves"}),`
...
`,e.jsxs("ul",{className:"space-y-2 text-text-secondary",children:[e.jsx(r,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Compile-time confidence in script code"}),` — typos, missing
members, and type mismatches are reported before the script ever runs.`]})}),e.jsx(r,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"A small runtime footprint"}),` — a custom stack-based virtual
machine and a compact bytecode format, not a full language runtime or JIT compiler.`]})}),e.jsx(r,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Direct C++ interoperability"}),` — native libraries are
ordinary shared libraries (DLL / SO / dylib) that export two well-known entry points, so hosts and
third-party authors can extend the language without modifying the compiler.`]})}),e.jsx(r,{children:e.jsxs(n.p,{children:[e.jsx("strong",{className:"text-text-primary",children:"Familiar syntax"}),` — a C-style grammar with classes,
generics, delegates, lambdas, and async/await, lowering the barrier for developers who already know
C#, C++, Java, or TypeScript.`]})})]}),`
`,e.jsx(s,{children:"Key ideas"}),`
...
initializes a `,e.jsx(t,{children:"CompilationContext"}),", compiles source into an"," ",`
`,e.jsx(t,{children:"ApplicationDomain"}),", and calls ",e.jsx(t,{children:"VM::Run()"}),` on the entry
...
each way carries a real ergonomic benefit. `,e.jsx(t,{children:"defer"}),` gives deterministic cleanup at
scope exit, while `,e.jsx(t,{children:"IDisposable"}),` lets authors attach custom cleanup logic to the
...
`,e.jsx(c,{tone:"blue",title:"Example",children:e.jsxs(n.p,{children:[e.jsx(t,{children:"defer"})," releases resources on scope exit, while ",e.jsx(t,{children:"IDisposable"})," ",`
